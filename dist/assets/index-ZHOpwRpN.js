 ...
 */var Tv;function FS(){if(Tv)return Le;Tv=1;var n=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),s=Symbol.for("react.profiler"),a=Symbol.for("react.provider"),u=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),E=Symbol.iterator;function T(L){return L===null||typeof L!="object"?null:(L=E&&L[E]||L["@@iterator"],typeof L=="function"?L:null)}var D={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},V=Object.assign,q={};function B(L,H,de){this.props=L,this.context=H,this.refs=q,this.updater=de||D}B.prototype.isReactComponent={},B.prototype.setState=function(L,H){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,H,"setState")},B.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function J(){}J.prototype=B.prototype;function re(L,H,de){this.props=L,this.context=H,this.refs=q,this.updater=de||D}var ae=re.prototype=new J;ae.constructor=re,V(ae,B.prototype),ae.isPureReactComponent=!0;var pe=Array.isArray,Me=Object.prototype.hasOwnProperty,Ae={current:null},O={key:!0,ref:!0,__self:!0,__source:!0};function A(L,H,de){var Ne,Pe={},be=null,fe=null;if(H!=null)for(Ne in H.ref!==void 0&&(fe=H.ref),H.key!==void 0&&(be=""+H.key),H)Me.call(H,Ne)&&!O.hasOwnProperty(Ne)&&(Pe[Ne]=H[Ne]);var Be=arguments.length-2;if(Be===1)Pe.children=de;else if(1<Be){for(var je=Array(Be),Dt=0;Dt<Be;Dt++)je[Dt]=arguments[Dt+2];Pe.children=je}if(L&&L.defaultProps)for(Ne in Be=L.defaultProps,Be)Pe[Ne]===void 0&&(Pe[Ne]=Be[Ne]);return{$$typeof:n,type:L,key:be,ref:fe,props:Pe,_owner:Ae.current}}function S(L,H){return{$$typeof:n,type:L.type,key:H,ref:L.ref,props:L.props,_owner:L._owner}}function R(L){return typeof L=="object"&&L!==null&&L.$$typeof===n}function k(L){var H={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(de){return H[de]})}var N=/\/+/g;function C(L,H){return typeof L=="object"&&L!==null&&L.key!=null?k(""+L.key):H.toString(36)}function Ee(L,H,de,Ne,Pe){var be=typeof L;(be==="undefined"||be==="boolean")&&(L=null);var fe=!1;if(L===null)fe=!0;else switch(be){case"string":case"number":fe=!0;break;case"object":switch(L.$$typeof){case n:case e:fe=!0}}if(fe)return fe=L,Pe=Pe(fe),L=Ne===""?"."+C(fe,0):Ne,pe(Pe)?(de="",L!=null&&(de=L.replace(N,"$&/")+"/"),Ee(Pe,H,de,"",function(Dt){return Dt})):Pe!=null&&(R(Pe)&&(Pe=S(Pe,de+(!Pe.key||fe&&fe.key===Pe.key?"":(""+Pe.key).replace(N,"$&/")+"/")+L)),H.push(Pe)),1;if(fe=0,Ne=Ne===""?".":Ne+":",pe(L))for(var Be=0;Be<L.length;Be++){be=L[Be];var je=Ne+C(be,Be);fe+=Ee(be,H,de,je,Pe)}else if(je=T(L),typeof je=="function")for(L=je.call(L),Be=0;!(be=L.next()).done;)be=be.value,je=Ne+C(be,Be++),fe+=Ee(be,H,de,je,Pe);else if(be==="object")throw H=String(L),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return fe}function xe(L,H,de){if(L==null)return L;var Ne=[],Pe=0;return Ee(L,Ne,"","",function(be){return H.call(de,be,Pe++)}),Ne}function Ye(L){if(L._status===-1){var H=L._result;H=H(),H.then(function(de){(L._status===0||L._status===-1)&&(L._status=1,L._result=de)},function(de){(L._status===0||L._status===-1)&&(L._status=2,L._result=de)}),L._status===-1&&(L._status=0,L._result=H)}if(L._status===1)return L._result.default;throw L._result}var we={current:null},Y={transition:null},me={ReactCurrentDispatcher:we,ReactCurrentBatchConfig:Y,ReactCurrentOwner:Ae};function ie(){throw Error("act(...) is not supported in production builds of React.")}return Le.Children={map:xe,forEach:function(L,H,de){xe(L,function(){H.apply(this,arguments)},de)},count:function(L){var H=0;return xe(L,function(){H++}),H},toArray:function(L){return xe(L,function(H){return H})||[]},only:function(L){if(!R(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},Le.Component=B,Le.Fragment=t,Le.Profiler=s,Le.PureComponent=re,Le.StrictMode=r,Le.Suspense=f,Le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=me,Le.act=ie,Le.cloneElement=function(L,H,de){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var Ne=V({},L.props),Pe=L.key,be=L.ref,fe=L._owner;if(H!=null){if(H.ref!==void 0&&(be=H.ref,fe=Ae.current),H.key!==void 0&&(Pe=""+H.key),L.type&&L.type.defaultProps)var Be=L.type.defaultProps;for(je in H)Me.call(H,je)&&!O.hasOwnProperty(je)&&(Ne[je]=H[je]===void 0&&Be!==void 0?Be[je]:H[je])}var je=arguments.length-2;if(je===1)Ne.children=de;else if(1<je){Be=Array(je);for(var Dt=0;Dt<je;Dt++)Be[Dt]=arguments[Dt+2];Ne.children=Be}return{$$typeof:n,type:L.type,key:Pe,ref:be,props:Ne,_owner:fe}},Le.createContext=function(L){return L={$$typeof:u,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:a,_context:L},L.Consumer=L},Le.createElement=A,Le.createFactory=function(L){var H=A.bind(null,L);return H.type=L,H},Le.createRef=function(){return{current:null}},Le.forwardRef=function(L){return{$$typeof:d,render:L}},Le.isValidElement=R,Le.lazy=function(L){return{$$typeof:v,_payload:{_status:-1,_result:L},_init:Ye}},Le.memo=function(L,H){return{$$typeof:m,type:L,compare:H===void 0?null:H}},Le.startTransition=function(L){var H=Y.transition;Y.transition={};try{L()}finally{Y.transition=H}},Le.unstable_act=ie,Le.useCallback=function(L,H){return we.current.useCallback(L,H)},Le.useContext=function(L){return we.current.useContext(L)},Le.useDebugValue=function(){},Le.useDeferredValue=function(L){return we.current.useDeferredValue(L)},Le.useEffect=function(L,H){return we.current.useEffect(L,H)},Le.useId=function(){return we.current.useId()},Le.useImperativeHandle=function(L,H,de){return we.current.useImperativeHandle(L,H,de)},Le.useInsertionEffect=function(L,H){return we.current.useInsertionEffect(L,H)},Le.useLayoutEffect=function(L,H){return we.current.useLayoutEffect(L,H)},Le.useMemo=function(L,H){return we.current.useMemo(L,H)},Le.useReducer=function(L,H,de){return we.current.useReducer(L,H,de)},Le.useRef=function(L){return we.current.useRef(L)},Le.useState=function(L){return we.current.useState(L)},Le.useSyncExternalStore=function(L,H,de){return we.current.useSyncExternalStore(L,H,de)},Le.useTransition=function(){return we.current.useTransition()},Le.version="18.3.1",Le}var Iv;function Lm(){return Iv||(Iv=1,wp.exports=FS()),wp.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rv;function zS(){return Rv||(Rv=1,function(n){function e(Y,me){var ie=Y.length;Y.push(me);e:for(;0<ie;){var L=ie-1>>>1,H=Y[L];if(0<s(H,me))Y[L]=me,Y[ie]=H,ie=L;else break e}}function t(Y){return Y.length===0?null:Y[0]}function r(Y){if(Y.length===0)return null;var me=Y[0],ie=Y.pop();if(ie!==me){Y[0]=ie;e:for(var L=0,H=Y.length,de=H>>>1;L<de;){var Ne=2*(L+1)-1,Pe=Y[Ne],be=Ne+1,fe=Y[be];if(0>s(Pe,ie))be<H&&0>s(fe,Pe)?(Y[L]=fe,Y[be]=ie,L=be):(Y[L]=Pe,Y[Ne]=ie,L=Ne);else if(be<H&&0>s(fe,ie))Y[L]=fe,Y[be]=ie,L=be;else break e}}return me}function s(Y,me){var ie=Y.sortIndex-me.sortIndex;return ie!==0?ie:Y.id-me.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;n.unstable_now=function(){return a.now()}}else{var u=Date,d=u.now();n.unstable_now=function(){return u.now()-d}}var f=[],m=[],v=1,E=null,T=3,D=!1,V=!1,q=!1,B=typeof setTimeout=="function"?setTimeout:null,J=typeof clearTimeout=="function"?clearTimeout:null,re=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ae(Y){for(var me=t(m);me!==null;){if(me.callback===null)r(m);else if(me.startTime<=Y)r(m),me.sortIndex=me.expirationTime,e(f,me);else break;me=t(m)}}function pe(Y){if(q=!1,ae(Y),!V)if(t(f)!==null)V=!0,Ye(Me);else{var me=t(m);me!==null&&we(pe,me.startTime-Y)}}function Me(Y,me){V=!1,q&&(q=!1,J(A),A=-1),D=!0;var ie=T;try{for(ae(me),E=t(f);E!==null&&(!(E.expirationTime>me)||Y&&!k());){var L=E.callback;if(typeof L=="function"){E.callback=null,T=E.priorityLevel;var H=L(E.expirationTime<=me);me=n.unstable_now(),typeof H=="function"?E.callback=H:E===t(f)&&r(f),ae(me)}else r(f);E=t(f)}if(E!==null)var de=!0;else{var Ne=t(m);Ne!==null&&we(pe,Ne.startTime-me),de=!1}return de}finally{E=null,T=ie,D=!1}}var Ae=!1,O=null,A=-1,S=5,R=-1;function k(){return!(n.unstable_now()-R<S)}function N(){if(O!==null){var Y=n.unstable_now();R=Y;var me=!0;try{me=O(!0,Y)}finally{me?C():(Ae=!1,O=null)}}else Ae=!1}var C;if(typeof re=="function")C=function(){re(N)};else if(typeof MessageChannel<"u"){var Ee=new MessageChannel,xe=Ee.port2;Ee.port1.onmessage=N,C=function(){xe.postMessage(null)}}else C=function(){B(N,0)};function Ye(Y){O=Y,Ae||(Ae=!0,C())}function we(Y,me){A=B(function(){Y(n.unstable_now())},me)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(Y){Y.callback=null},n.unstable_continueExecution=function(){V||D||(V=!0,Ye(Me))},n.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<Y?Math.floor(1e3/Y):5},n.unstable_getCurrentPriorityLevel=function(){return T},n.unstable_getFirstCallbackNode=function(){return t(f)},n.unstable_next=function(Y){switch(T){case 1:case 2:case 3:var me=3;break;default:me=T}var ie=T;T=me;try{return Y()}finally{T=ie}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(Y,me){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var ie=T;T=Y;try{return me()}finally{T=ie}},n.unstable_scheduleCallback=function(Y,me,ie){var L=n.unstable_now();switch(typeof ie=="object"&&ie!==null?(ie=ie.delay,ie=typeof ie=="number"&&0<ie?L+ie:L):ie=L,Y){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=ie+H,Y={id:v++,callback:me,priorityLevel:Y,startTime:ie,expirationTime:H,sortIndex:-1},ie>L?(Y.sortIndex=ie,e(m,Y),t(f)===null&&Y===t(m)&&(q?(J(A),A=-1):q=!0,we(pe,ie-L))):(Y.sortIndex=H,e(f,Y),V||D||(V=!0,Ye(Me))),Y},n.unstable_shouldYield=k,n.unstable_wrapCallback=function(Y){var me=T;return function(){var ie=T;T=me;try{return Y.apply(this,arguments)}finally{T=ie}}}}(Cp)),Cp}var Av;function BS(){return Av||(Av=1,Ip.exports=zS()),Ip.exports}/**
 * @license React
 ...
 */const Hw={NODE_ADMIN:!1,SDK_VERSION:"${JSCORE_VERSION}"};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee=function(n,e){if(!n)throw Oa(e)},Oa=function(n){return new Error("Firebase Database ("+Hw.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ma(n){const e=[];for(const[t,r]of Object.entries(n))Array.isArray(r)?r.forEach(s=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(s))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(r));return e.length?"&"+e.join("&"):""}function $l(n){const e={};return n.replace(/^\?/,"").split("&").forEach(r=>{if(r){const[s,a]=r.split("=");e[decodeURIComponent(s)]=decodeURIComponent(a)}}),e}function Hl(n){const e=n.indexOf("?");if(!e)return"";const t=n.indexOf("#",e);return n.substring(e,t>0?t:void 0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ui=new fd("@firebase/app"),WR="@firebase/app-compat",qR="@firebase/analytics-compat",$R="@firebase/analytics",HR="@firebase/app-check-compat",GR="@firebase/app-check",KR="@firebase/auth",QR="@firebase/auth-compat",YR="@firebase/database",XR="@firebase/data-connect",JR="@firebase/database-compat",ZR="@firebase/functions",eA="@firebase/functions-compat",tA="@firebase/installations",nA="@firebase/installations-compat",rA="@firebase/messaging",iA="@firebase/messaging-compat",sA="@firebase/performance",oA="@firebase/performance-compat",aA="@firebase/remote-config",lA="@firebase/remote-config-compat",uA="@firebase/storage",cA="@firebase/storage-compat",hA="@firebase/firestore",dA="@firebase/ai",fA="@firebase/firestore-compat",pA="firebase",mA="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zl(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function $A(n,e=!1){const t=nt(n),r=await t.getIdToken(e),s=Hm(r);Ie(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const a=typeof s.firebase=="object"?s.firebase:void 0,u=a?.sign_in_provider;return{claims:s,token:r,authTime:Zl(xp(s.auth_time)),issuedAtTime:Zl(xp(s.iat)),expirationTime:Zl(xp(s.exp)),signInProvider:u||null,signInSecondFactor:a?.sign_in_second_factor||null}}function xp(n){return Number(n)*1e3}function Hm(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return ph("JWT malformed, contained fewer than 3 sections"),null;try{const s=Rh(t);return s?JSON.parse(s):(ph("Failed to decode base64 JWT payload"),null)}catch(s){return ph("Caught error parsing JWT payload as JSON",s?.toString()),null}}function qv(n){const e=Hm(n);return Ie(e,"internal-error"),Ie(typeof e.exp<"u","internal-error"),Ie(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function du(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof mi&&HA(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function HA({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fa{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Ie(e.idToken,"internal-error"),Ie(typeof e.idToken<"u","internal-error"),Ie(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):qv(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){Ie(e.length!==0,"internal-error");const t=qv(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(Ie(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:s,expiresIn:a}=await YA(e,t);this.updateTokensAndExpiration(r,s,Number(a))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:s,expirationTime:a}=t,u=new fa;return r&&(Ie(typeof r=="string","internal-error",{appName:e}),u.refreshToken=r),s&&(Ie(typeof s=="string","internal-error",{appName:e}),u.accessToken=s),a&&(Ie(typeof a=="number","internal-error",{appName:e}),u.expirationTime=a),u}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new fa,this.toJSON())}_performRefresh(){return ri("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zi(n,e){Ie(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class cr{constructor(e){var{uid:t,auth:r,stsTokenManager:s}=e,a=Wm(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new GA(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=r,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=a.displayName||null,this.email=a.email||null,this.emailVerified=a.emailVerified||!1,this.phoneNumber=a.phoneNumber||null,this.photoURL=a.photoURL||null,this.isAnonymous=a.isAnonymous||!1,this.tenantId=a.tenantId||null,this.providerData=a.providerData?[...a.providerData]:[],this.metadata=new Xp(a.createdAt||void 0,a.lastLoginAt||void 0)}async getIdToken(e){const t=await du(this,this.stsTokenManager.getToken(this.auth,e));return Ie(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return $A(this,e)}reload(){return KA(this)}_assign(e){this!==e&&(Ie(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>Object.assign({},t)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new cr(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return t.metadata._copy(this.metadata),t}_onReload(e){Ie(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),t&&await bh(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(bn(this.auth.app))return Promise.reject(oi(this.auth));const e=await this.getIdToken();return await du(this,qA(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var r,s,a,u,d,f,m,v;const E=(r=t.displayName)!==null&&r!==void 0?r:void 0,T=(s=t.email)!==null&&s!==void 0?s:void 0,D=(a=t.phoneNumber)!==null&&a!==void 0?a:void 0,V=(u=t.photoURL)!==null&&u!==void 0?u:void 0,q=(d=t.tenantId)!==null&&d!==void 0?d:void 0,B=(f=t._redirectEventId)!==null&&f!==void 0?f:void 0,J=(m=t.createdAt)!==null&&m!==void 0?m:void 0,re=(v=t.lastLoginAt)!==null&&v!==void 0?v:void 0,{uid:ae,emailVerified:pe,isAnonymous:Me,providerData:Ae,stsTokenManager:O}=t;Ie(ae&&O,e,"internal-error");const A=fa.fromJSON(this.name,O);Ie(typeof ae=="string",e,"internal-error"),zi(E,e.name),zi(T,e.name),Ie(typeof pe=="boolean",e,"internal-error"),Ie(typeof Me=="boolean",e,"internal-error"),zi(D,e.name),zi(V,e.name),zi(q,e.name),zi(B,e.name),zi(J,e.name),zi(re,e.name);const S=new cr({uid:ae,auth:e,email:T,emailVerified:pe,displayName:E,isAnonymous:Me,photoURL:V,phoneNumber:D,tenantId:q,stsTokenManager:A,createdAt:J,lastLoginAt:re});return Ae&&Array.isArray(Ae)&&(S.providerData=Ae.map(R=>Object.assign({},R))),B&&(S._redirectEventId=B),S}static async _fromIdTokenResponse(e,t,r=!1){const s=new fa;s.updateFromServerResponse(t);const a=new cr({uid:t.localId,auth:e,stsTokenManager:s,isAnonymous:r});return await bh(a),a}static async _fromGetAccountInfoResponse(e,t,r){const s=t.users[0];Ie(s.localId!==void 0,"internal-error");const a=s.providerUserInfo!==void 0?p0(s.providerUserInfo):[],u=!(s.email&&s.passwordHash)&&!a?.length,d=new fa;d.updateFromIdToken(r);const f=new cr({uid:s.localId,auth:e,stsTokenManager:d,isAnonymous:u}),m={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Xp(s.createdAt,s.lastLoginAt),isAnonymous:!(s.email&&s.passwordHash)&&!a?.length};return Object.assign(f,m),f}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class m0{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}m0.type="NONE";const Hv=m0;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mh(n,e,t){return`firebase:${n}:${e}:${t}`}class pa{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:a}=this.auth;this.fullUserKey=mh(this.userKey,s.apiKey,a),this.fullPersistenceKey=mh("persistence",s.apiKey,a),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Nh(this.auth,{idToken:e}).catch(()=>{});return t?cr._fromGetAccountInfoResponse(this.auth,t,e):null}return cr._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new pa(ii(Hv),e,r);const s=(await Promise.all(t.map(async m=>{if(await m._isAvailable())return m}))).filter(m=>m);let a=s[0]||ii(Hv);const u=mh(r,e.config.apiKey,e.name);let d=null;for(const m of t)try{const v=await m._get(u);if(v){let E;if(typeof v=="string"){const T=await Nh(e,{idToken:v}).catch(()=>{});if(!T)break;E=await cr._fromGetAccountInfoResponse(e,T,v)}else E=cr._fromJSON(e,v);m!==a&&(d=E),a=m;break}}catch{}const f=s.filter(m=>m._shouldAllowMigration);return!a._shouldAllowMigration||!f.length?new pa(a,e,r):(a=f[0],d&&await a._set(u,d.toJSON()),await Promise.all(t.map(async m=>{if(m!==a)try{await m._remove(u)}catch{}})),new pa(a,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function f1(n,e){const t=pd(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),a=t.getOptions();if(Or(a,e??{}))return s;fr(s,"already-initialized")}return t.initialize({options:e})}function p1(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(ii);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function m1(n,e,t){const r=oo(n);Ie(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,a=A0(e),{host:u,port:d}=g1(e),f=d===null?"":`:${d}`,m={url:`${a}//${u}${f}/`},v=Object.freeze({host:u,port:d,protocol:a.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){Ie(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),Ie(Or(m,r.config.emulator)&&Or(v,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=m,r.emulatorConfig=v,r.settings.appVerificationDisabledForTesting=!0,hs(u)?(Fm(`${a}//${u}${f}`),Um("Auth",!0)):_1()}function A0(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function g1(n){const e=A0(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const a=s[1];return{host:a,port:Yv(r.substr(a.length+1))}}else{const[a,u]=r.split(":");return{host:a,port:Yv(u)}}}function Yv(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function _1(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I1(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function C1(n){const e=$l(Hl(n)).link,t=e?$l(Hl(e)).deep_link_id:null,r=$l(Hl(n)).deep_link_id;return(r?$l(Hl(r)).link:null)||r||t||e||n}class Qm{constructor(e){var t,r,s,a,u,d;const f=$l(Hl(e)),m=(t=f.apiKey)!==null&&t!==void 0?t:null,v=(r=f.oobCode)!==null&&r!==void 0?r:null,E=I1((s=f.mode)!==null&&s!==void 0?s:null);Ie(m&&v&&E,"argument-error"),this.apiKey=m,this.operation=E,this.code=v,this.continueUrl=(a=f.continueUrl)!==null&&a!==void 0?a:null,this.languageCode=(u=f.lang)!==null&&u!==void 0?u:null,this.tenantId=(d=f.tenantId)!==null&&d!==void 0?d:null}static parseLink(e){const t=C1(e);try{return new Qm(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function A1(n,e,t=!1){const{auth:r}=n;if(bn(r.app))return Promise.reject(oi(r));const s="reauthenticate";try{const a=await du(n,k0(r,s,e,n),t);Ie(a.idToken,r,"internal-error");const u=Hm(a.idToken);Ie(u,r,"internal-error");const{sub:d}=u;return Ie(n.uid===d,r,"user-mismatch"),Js._forOperation(n,s,a)}catch(a){throw a?.code==="auth/user-not-found"&&fr(r,"user-mismatch"),a}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y1(n,e){return e?ii(e):(Ie(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j0{constructor(e,t,r,s,a=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=a,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:a,error:u,type:d}=e;if(u){this.reject(u);return}const f={auth:this.auth,requestUri:t,sessionId:r,tenantId:a||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(d)(f))}catch(m){this.reject(m)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return X1;case"linkViaPopup":case"linkViaRedirect":return Z1;case"reauthViaPopup":case"reauthViaRedirect":return J1;default:fr(this.auth,"internal-error")}}resolve(e){ci(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){ci(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Np="webStorageSupport";class VP{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=M0,this._completeRedirectFn=aP,this._overrideRedirectResult=iP}async _openPopup(e,t,r,s){var a;ci((a=this.eventManagers[e._key()])===null||a===void 0?void 0:a.manager,"_initialize() not called before _openPopup()");const u=await rE(e,t,r,Yp(),s);return NP(e,u,Ym())}async _openRedirect(e,t,r,s){await this._originValidation(e);const a=await rE(e,t,r,Yp(),s);return j1(a),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:a}=this.eventManagers[t];return s?Promise.resolve(s):(ci(a,"If manager is not set, promise should be"),a)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await SP(e),r=new uP(e);return t.register("authEvent",s=>(Ie(s?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Np,{type:Np},s=>{var a;const u=(a=s?.[0])===null||a===void 0?void 0:a[Np];u!==void 0&&t(!!u),fr(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=pP(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return I0()||_0()||Gm()}}const FP=VP;var iE="@firebase/auth",sE="1.10.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`);for(let I=0;I<c.length;I++){if(re(c[I]))continue;var y=k(c[I]);const F=y[0];if(y=y[1],typeof y!="string")continue;y=y.trim();const W=g[F]||[];g[F]=W,W.push(y)}O(g,function(I){return I.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function vr(c,g,y){return y&&y.internalChannelParams&&y.internalChannelParams[c]||g}function pl(c){this.Aa=0,this.i=[],this.j=new Ts,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=vr("failFast",!1,c),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=vr("baseRetryDelayMs",5e3,c),this.cb=vr("retryDelaySeedMs",1e4,c),this.Wa=vr("forwardChannelMaxRetries",2,c),this.wa=vr("forwardChannelRequestTimeoutMs",2e4,c),this.pa=c&&c.xmlHttpFactory||void 0,this.Xa=c&&c.Tb||void 0,this.Ca=c&&c.useFetchStreams||!1,this.L=void 0,this.J=c&&c.supportsCrossDomainXhr||!1,this.K="",this.h=new Rs(c&&c.concurrentRequestLimit),this.Da=new Xd,this.P=c&&c.fastHandshake||!1,this.O=c&&c.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=c&&c.Rb||!1,c&&c.xa&&this.j.xa(),c&&c.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&c&&c.detectBufferingProxy||!1,this.ja=void 0,c&&c.longPollingTimeout&&0<c.longPollingTimeout&&(this.ja=c.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=pl.prototype,n.la=8,n.G=1,n.connect=function(c,g,y,I){gt(0),this.W=c,this.H=g||{},y&&I!==void 0&&(this.H.OSID=y,this.H.OAID=I),this.F=this.X,this.I=uc(this,null,this.W),Er(this)};function $t(c){if(bo(c),c.G==3){var g=c.U++,y=Rn(c.I);if(et(y,"SID",c.K),et(y,"RID",g),et(y,"TYPE","terminate"),$r(c,y),g=new Xn(c,c.j,g),g.L=2,g.v=Ti(Rn(y)),y=!1,d.navigator&&d.navigator.sendBeacon)try{y=d.navigator.sendBeacon(g.v.toString(),"")}catch{}!y&&d.Image&&(new Image().src=g.v,y=!0),y||(g.g=cc(g.j,null),g.g.ea(g.v)),g.F=Date.now(),rt(g)}lc(c)}function nr(c){c.g&&(ml(c),c.g.cancel(),c.g=null)}function bo(c){nr(c),c.u&&(d.clearTimeout(c.u),c.u=null),Mo(c),c.h.cancel(),c.s&&(typeof c.s=="number"&&d.clearTimeout(c.s),c.s=null)}function Er(c){if(!Sn(c.h)&&!c.s){c.s=!0;var g=c.Ga;we||ie(),Y||(we(),Y=!0),me.add(g,c),c.B=0}}function Zd(c,g){return Yu(c.h)>=c.h.j-(c.s?1:0)?!1:c.s?(c.i=g.D.concat(c.i),!0):c.G==1||c.G==2||c.B>=(c.Va?0:c.Wa)?!1:(c.s=Kn(T(c.Ga,c,g),ac(c,c.B)),c.B++,!0)}n.Ga=function(c){if(this.s)if(this.s=null,this.G==1){if(!c){this.U=Math.floor(1e5*Math.random()),c=this.U++;const F=new Xn(this,this.j,c);let W=this.o;if(this.S&&(W?(W=A(W),R(W,this.S)):W=this.S),this.m!==null||this.O||(F.H=W,W=null),this.P)e:{for(var g=0,y=0;y<this.i.length;y++){t:{var I=this.i[y];if("__data__"in I.map&&(I=I.map.__data__,typeof I=="string")){I=I.length;break t}I=void 0}if(I===void 0)break;if(g+=I,4096<g){g=y;break e}if(g===4096||y===this.i.length-1){g=y+1;break e}}g=1e3}else g=1e3;g=Ri(this,F,g),y=Rn(this.I),et(y,"RID",c),et(y,"CVER",22),this.D&&et(y,"X-HTTP-Session-Id",this.D),$r(this,y),W&&(this.O?g="headers="+encodeURIComponent(String(qr(W)))+"&"+g:this.m&&Si(y,this.m,W)),ul(this.h,F),this.Ua&&et(y,"TYPE","init"),this.P?(et(y,"$req",g),et(y,"SID","null"),F.T=!0,So(F,y,null)):So(F,y,g),this.G=2}}else this.G==3&&(c?Do(this,c):this.i.length==0||Sn(this.h)||Do(this))};function Do(c,g){var y;g?y=g.l:y=c.U++;const I=Rn(c.I);et(I,"SID",c.K),et(I,"RID",y),et(I,"AID",c.T),$r(c,I),c.m&&c.o&&Si(I,c.m,c.o),y=new Xn(c,c.j,y,c.B+1),c.m===null&&(y.H=c.o),g&&(c.i=g.D.concat(c.i)),g=Ri(c,y,1e3),y.I=Math.round(.5*c.wa)+Math.round(.5*c.wa*Math.random()),ul(c.h,y),So(y,I,g)}function $r(c,g){c.H&&Ae(c.H,function(y,I){et(g,I,y)}),c.l&&vi({},function(y,I){et(g,I,y)})}function Ri(c,g,y){y=Math.min(c.i.length,y);var I=c.l?T(c.l.Na,c.l,c):null;e:{var F=c.i;let W=-1;for(;;){const te=["count="+y];W==-1?0<y?(W=F[0].g,te.push("ofs="+W)):W=0:te.push("ofs="+W);let Xe=!0;for(let kt=0;kt<y;kt++){let qe=F[kt].g;const Ot=F[kt].map;if(qe-=W,0>qe)W=Math.max(0,F[kt].g-100),Xe=!1;else try{ic(Ot,te,"req"+qe+"_")}catch{I&&I(Ot)}}if(Xe){I=te.join("&");break e}}}return c=c.i.splice(0,y),g.D=c,I}function Ns(c){if(!c.g&&!c.u){c.Y=1;var g=c.Fa;we||ie(),Y||(we(),Y=!0),me.add(g,c),c.v=0}}function Oo(c){return c.g||c.u||3<=c.v?!1:(c.Y++,c.u=Kn(T(c.Fa,c),ac(c,c.v)),c.v++,!0)}n.Fa=function(){if(this.u=null,oc(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var c=2*this.R;this.j.info("BP detection timer enabled: "+c),this.A=Kn(T(this.ab,this),c)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,gt(10),nr(this),oc(this))};function ml(c){c.A!=null&&(d.clearTimeout(c.A),c.A=null)}function oc(c){c.g=new Xn(c,c.j,"rpc",c.Y),c.m===null&&(c.g.H=c.o),c.g.O=0;var g=Rn(c.qa);et(g,"RID","rpc"),et(g,"SID",c.K),et(g,"AID",c.T),et(g,"CI",c.F?"0":"1"),!c.F&&c.ja&&et(g,"TO",c.ja),et(g,"TYPE","xmlhttp"),$r(c,g),c.m&&c.o&&Si(g,c.m,c.o),c.L&&(c.g.I=c.L);var y=c.g;c=c.ia,y.L=1,y.v=Ti(Rn(g)),y.m=null,y.P=!0,al(y,c)}n.Za=function(){this.C!=null&&(this.C=null,nr(this),Oo(this),gt(19))};function Mo(c){c.C!=null&&(d.clearTimeout(c.C),c.C=null)}function Lo(c,g){var y=null;if(c.g==g){Mo(c),ml(c),c.g=null;var I=2}else if(ln(c.h,g))y=g.D,Xu(c.h,g),I=1;else return;if(c.G!=0){if(g.o)if(I==1){y=g.m?g.m.length:0,g=Date.now()-g.F;var F=c.B;I=ws(),Pt(I,new wo(I,y)),Er(c)}else Ns(c);else if(F=g.s,F==3||F==0&&0<g.X||!(I==1&&Zd(c,g)||I==2&&Oo(c)))switch(y&&0<y.length&&(g=c.h,g.i=g.i.concat(y)),F){case 1:Hr(c,5);break;case 4:Hr(c,10);break;case 3:Hr(c,6);break;default:Hr(c,2)}}}function ac(c,g){let y=c.Ta+Math.floor(Math.random()*c.cb);return c.isActive()||(y*=2),y*g}function Hr(c,g){if(c.j.info("Error code "+g),g==2){var y=T(c.fb,c),I=c.Xa;const F=!I;I=new Br(I||"//www.google.com/images/cleardot.gif"),d.location&&d.location.protocol=="http"||Ps(I,"https"),Ti(I),F?Yd(I.toString(),y):rc(I.toString(),y)}else gt(2);c.G=0,c.l&&c.l.sa(g),lc(c),bo(c)}n.fb=function(c){c?(this.j.info("Successfully pinged google.com"),gt(2)):(this.j.info("Failed to ping google.com"),gt(1))};function lc(c){if(c.G=0,c.ka=[],c.l){const g=Ju(c.h);(g.length!=0||c.i.length!=0)&&(B(c.ka,g),B(c.ka,c.i),c.h.i.length=0,q(c.i),c.i.length=0),c.l.ra()}}function uc(c,g,y){var I=y instanceof Br?Rn(y):new Br(y);if(I.g!="")g&&(I.g=g+"."+I.g),Ei(I,I.s);else{var F=d.location;I=F.protocol,g=g?g+"."+F.hostname:F.hostname,F=+F.port;var W=new Br(null);I&&Ps(W,I),g&&(W.g=g),F&&Ei(W,F),y&&(W.l=y),I=W}return y=c.D,g=c.ya,y&&g&&et(I,y,g),et(I,"VER",c.la),$r(c,I),I}function cc(c,g,y){if(g&&!c.J)throw Error("Can't create secondary domain capable XhrIo object.");return g=c.Ca&&!c.pa?new ut(new Wr({eb:y})):new ut(c.pa),g.Ha(c.J),g}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function gl(){}n=gl.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Vo(){}Vo.prototype.g=function(c,g){return new un(c,g)};function un(c,g){At.call(this),this.g=new pl(g),this.l=c,this.h=g&&g.messageUrlParams||null,c=g&&g.messageHeaders||null,g&&g.clientProtocolHeaderRequired&&(c?c["X-Client-Protocol"]="webchannel":c={"X-Client-Protocol":"webchannel"}),this.g.o=c,c=g&&g.initMessageHeaders||null,g&&g.messageContentType&&(c?c["X-WebChannel-Content-Type"]=g.messageContentType:c={"X-WebChannel-Content-Type":g.messageContentType}),g&&g.va&&(c?c["X-WebChannel-Client-Profile"]=g.va:c={"X-WebChannel-Client-Profile":g.va}),this.g.S=c,(c=g&&g.Sb)&&!re(c)&&(this.g.m=c),this.v=g&&g.supportsCrossDomainXhr||!1,this.u=g&&g.sendRawJson||!1,(g=g&&g.httpSessionIdParam)&&!re(g)&&(this.g.D=g,c=this.h,c!==null&&g in c&&(c=this.h,g in c&&delete c[g])),this.j=new wr(this)}V(un,At),un.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},un.prototype.close=function(){$t(this.g)},un.prototype.o=function(c){var g=this.g;if(typeof c=="string"){var y={};y.__data__=c,c=y}else this.u&&(y={},y.__data__=Za(c),c=y);g.i.push(new Qu(g.Ya++,c)),g.G==3&&Er(g)},un.prototype.N=function(){this.g.l=null,delete this.j,$t(this.g),delete this.g,un.aa.N.call(this)};function hc(c){mr.call(this),c.__headers__&&(this.headers=c.__headers__,this.statusCode=c.__status__,delete c.__headers__,delete c.__status__);var g=c.__sm__;if(g){e:{for(const y in g){c=y;break e}c=void 0}(this.i=c)&&(c=this.i,g=g!==null&&c in g?g[c]:void 0),this.data=g}else this.data=c}V(hc,mr);function dc(){Eo.call(this),this.status=1}V(dc,Eo);function wr(c){this.g=c}V(wr,gl),wr.prototype.ua=function(){Pt(this.g,"a")},wr.prototype.ta=function(c){Pt(this.g,new hc(c))},wr.prototype.sa=function(c){Pt(this.g,new dc)},wr.prototype.ra=function(){Pt(this.g,"b")},Vo.prototype.createWebChannel=Vo.prototype.g,un.prototype.send=un.prototype.o,un.prototype.open=un.prototype.m,un.prototype.close=un.prototype.close,G0=function(){return new Vo},H0=function(){return ws()},$0=gr,em={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Io.NO_ERROR=0,Io.TIMEOUT=8,Io.HTTP_ERROR=6,yh=Io,$u.COMPLETE="complete",q0=$u,vo.EventType=Ln,Ln.OPEN="a",Ln.CLOSE="b",Ln.ERROR="c",Ln.MESSAGE="d",At.prototype.listen=At.prototype.K,Gl=vo,ut.prototype.listenOnce=ut.prototype.L,ut.prototype.getLastError=ut.prototype.Ka,ut.prototype.getLastErrorCode=ut.prototype.Ba,ut.prototype.getStatus=ut.prototype.Z,ut.prototype.getResponseJson=ut.prototype.Oa,ut.prototype.getResponseText=ut.prototype.oa,ut.prototype.send=ut.prototype.ea,ut.prototype.setWithCredentials=ut.prototype.Ha,W0=ut}).apply(typeof ah<"u"?ah:typeof self<"u"?self:typeof window<"u"?window:{});const lE="@firebase/firestore",uE="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,K0(n,r,t)}function K0(n,e,t){let r=`FIRESTORE (${Va}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw hi(r),new Error(r)}function He(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||K0(e,s,r)}function Re(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dE="__name__";class Rr{constructor(e,t,r){t===void 0?t=0:t>e.length&&_e(637,{offset:t,range:e.length}),r===void 0?r=e.length-t:r>e.length-t&&_e(1746,{length:r,range:e.length-t}),this.segments=e,this.offset=t,this.len=r}get length(){return this.len}isEqual(e){return Rr.comparator(this,e)===0}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof Rr?e.forEach(r=>{t.push(r)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,r=this.limit();t<r;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const r=Math.min(e.length,t.length);for(let s=0;s<r;s++){const a=Rr.compareSegments(e.get(s),t.get(s));if(a!==0)return a}return De(e.length,t.length)}static compareSegments(e,t){const r=Rr.isNumericId(e),s=Rr.isNumericId(t);return r&&!s?-1:!r&&s?1:r&&s?Rr.extractNumericId(e).compare(Rr.extractNumericId(t)):tm(e,t)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return Qi.fromString(e.substring(4,e.length-2))}}class Ze extends Rr{construct(e,t,r){return new Ze(e,t,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const r of e){if(r.indexOf("//")>=0)throw new ne($.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);t.push(...r.split("/").filter(s=>s.length>0))}return new Ze(t)}static emptyPath(){return new Ze([])}}const tk=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Qt extends Rr{construct(e,t,r){return new Qt(e,t,r)}static isValidIdentifier(e){return tk.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Qt.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===dE}static keyField(){return new Qt([dE])}static fromServerFormat(e){const t=[];let r="",s=0;const a=()=>{if(r.length===0)throw new ne($.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(r),r=""};let u=!1;for(;s<e.length;){const d=e[s];if(d==="\\"){if(s+1===e.length)throw new ne($.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const f=e[s+1];if(f!=="\\"&&f!=="."&&f!=="`")throw new ne($.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);r+=f,s+=2}else d==="`"?(u=!u,s++):d!=="."||u?(r+=d,s++):(a(),s++)}if(a(),u)throw new ne($.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Qt(t)}static emptyPath(){return new Qt([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function St(n,e){const t={typeString:n};return e&&(t.value=e),t}function Nu(n,e){if(!J0(n))throw new ne($.INVALID_ARGUMENT,"JSON must be an object");let t;for(const r in e)if(e[r]){const s=e[r].typeString,a="value"in e[r]?{value:e[r].value}:void 0;if(!(r in n)){t=`JSON missing required field: '${r}'`;break}const u=n[r];if(s&&typeof u!==s){t=`JSON field '${r}' must be a ${s}.`;break}if(a!==void 0&&u!==a.value){t=`Expected '${r}' field to equal '${a.value}'`;break}}if(t)throw new ne($.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pu=-1;function rk(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=Te.fromTimestamp(r===1e9?new lt(t+1,0):new lt(t,r));return new ns(s,ge.empty(),e)}function ik(n){return new ns(n.readTime,n.key,pu)}class ns{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new ns(Te.min(),ge.empty(),pu)}static max(){return new ns(Te.max(),ge.empty(),pu)}}function sk(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=ge.comparator(n.documentKey,e.documentKey),t!==0?t:De(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fa(n){if(n.code!==$.FAILED_PRECONDITION||n.message!==ok)throw n;oe("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(e,t,r,s,a,u,d){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=a,this.data=u,this.documentState=d}static newInvalidDocument(e){return new Bt(e,0,Te.min(),Te.min(),Te.min(),dn.empty(),0)}static newFoundDocument(e,t,r,s){return new Bt(e,1,t,Te.min(),r,s,0)}static newNoDocument(e,t){return new Bt(e,2,t,Te.min(),Te.min(),dn.empty(),0)}static newUnknownDocument(e,t){return new Bt(e,3,t,Te.min(),Te.min(),dn.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(Te.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=dn.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=dn.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=Te.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Bt&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Bt(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nk=new Rt(ge.comparator);function di(){return Nk}const yT=new Rt(ge.comparator);function Kl(...n){let e=yT;for(const t of n)e=e.insert(t.key,t);return e}function vT(n){let e=yT;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Gs(){return nu()}function ET(){return nu()}function nu(){return new ao(n=>n.toString(),(n,e)=>n.isEqual(e))}const bk=new Rt(ge.comparator),Dk=new bt(ge.comparator);function ze(...n){let e=Dk;for(const t of n)e=e.add(t);return e}const Ok=new bt(De);function Mk(){return Ok}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Th{constructor(e,t,r,s){this.Se=e,this.removedTargetIds=t,this.key=r,this.be=s}}class bT{constructor(e,t){this.targetId=e,this.De=t}}class DT{constructor(e,t,r=Yt.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class ME{constructor(){this.ve=0,this.Ce=LE(),this.Fe=Yt.EMPTY_BYTE_STRING,this.Me=!1,this.xe=!0}get current(){return this.Me}get resumeToken(){return this.Fe}get Oe(){return this.ve!==0}get Ne(){return this.xe}Be(e){e.approximateByteSize()>0&&(this.xe=!0,this.Fe=e)}Le(){let e=ze(),t=ze(),r=ze();return this.Ce.forEach((s,a)=>{switch(a){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:_e(38017,{changeType:a})}}),new Mu(this.Fe,this.Me,e,t,r)}ke(){this.xe=!1,this.Ce=LE()}qe(e,t){this.xe=!0,this.Ce=this.Ce.insert(e,t)}Qe(e){this.xe=!0,this.Ce=this.Ce.remove(e)}$e(){this.ve+=1}Ue(){this.ve-=1,He(this.ve>=0,3241,{ve:this.ve})}Ke(){this.xe=!0,this.Me=!0}}class Hk{constructor(e){this.We=e,this.Ge=new Map,this.ze=di(),this.je=ch(),this.Je=ch(),this.He=new Rt(De)}Ye(e){for(const t of e.Se)e.be&&e.be.isFoundDocument()?this.Ze(t,e.be):this.Xe(t,e.key,e.be);for(const t of e.removedTargetIds)this.Xe(t,e.key,e.be)}et(e){this.forEachTarget(e,t=>{const r=this.tt(t);switch(e.state){case 0:this.nt(t)&&r.Be(e.resumeToken);break;case 1:r.Ue(),r.Oe||r.ke(),r.Be(e.resumeToken);break;case 2:r.Ue(),r.Oe||this.removeTarget(t);break;case 3:this.nt(t)&&(r.Ke(),r.Be(e.resumeToken));break;case 4:this.nt(t)&&(this.rt(t),r.Be(e.resumeToken));break;default:_e(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Ge.forEach((r,s)=>{this.nt(s)&&t(s)})}it(e){const t=e.targetId,r=e.De.count,s=this.st(t);if(s){const a=s.target;if(om(a))if(r===0){const u=new ge(a.path);this.Xe(t,u,Bt.newNoDocument(u,Te.min()))}else He(r===1,20013,{expectedCount:r});else{const u=this.ot(t);if(u!==r){const d=this._t(e),f=d?this.ut(d,e,u):1;if(f!==0){this.rt(t);const m=f===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.He=this.He.insert(t,m)}}}}}_t(e){const t=e.De.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:a=0}=t;let u,d;try{u=is(r).toUint8Array()}catch(f){if(f instanceof tT)return ts("Decoding the base64 bloom filter in existence filter failed ("+f.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw f}try{d=new lg(u,s,a)}catch(f){return ts(f instanceof Ql?"BloomFilter error: ":"Applying bloom filter failed: ",f),null}return d.fe===0?null:d}ut(e,t,r){return t.De.count===r-this.ht(e,t.targetId)?0:2}ht(e,t){const r=this.We.getRemoteKeysForTarget(t);let s=0;return r.forEach(a=>{const u=this.We.lt(),d=`projects/${u.projectId}/databases/${u.database}/documents/${a.path.canonicalString()}`;e.mightContain(d)||(this.Xe(t,a,null),s++)}),s}Pt(e){const t=new Map;this.Ge.forEach((a,u)=>{const d=this.st(u);if(d){if(a.current&&om(d.target)){const f=new ge(d.target.path);this.Tt(f).has(u)||this.It(u,f)||this.Xe(u,f,Bt.newNoDocument(f,e))}a.Ne&&(t.set(u,a.Le()),a.ke())}});let r=ze();this.Je.forEach((a,u)=>{let d=!0;u.forEachWhile(f=>{const m=this.st(f);return!m||m.purpose==="TargetPurposeLimboResolution"||(d=!1,!1)}),d&&(r=r.add(a))}),this.ze.forEach((a,u)=>u.setReadTime(e));const s=new Ad(e,t,this.He,this.ze,r);return this.ze=di(),this.je=ch(),this.Je=ch(),this.He=new Rt(De),s}Ze(e,t){if(!this.nt(e))return;const r=this.It(e,t.key)?2:0;this.tt(e).qe(t.key,r),this.ze=this.ze.insert(t.key,t),this.je=this.je.insert(t.key,this.Tt(t.key).add(e)),this.Je=this.Je.insert(t.key,this.dt(t.key).add(e))}Xe(e,t,r){if(!this.nt(e))return;const s=this.tt(e);this.It(e,t)?s.qe(t,1):s.Qe(t),this.Je=this.Je.insert(t,this.dt(t).delete(e)),this.Je=this.Je.insert(t,this.dt(t).add(e)),r&&(this.ze=this.ze.insert(t,r))}removeTarget(e){this.Ge.delete(e)}ot(e){const t=this.tt(e).Le();return this.We.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}$e(e){this.tt(e).$e()}tt(e){let t=this.Ge.get(e);return t||(t=new ME,this.Ge.set(e,t)),t}dt(e){let t=this.Je.get(e);return t||(t=new bt(De),this.Je=this.Je.insert(e,t)),t}Tt(e){let t=this.je.get(e);return t||(t=new bt(De),this.je=this.je.insert(e,t)),t}nt(e){const t=this.st(e)!==null;return t||oe("WatchChangeAggregator","Detected inactive target",e),t}st(e){const t=this.Ge.get(e);return t&&t.Oe?null:this.We.Et(e)}rt(e){this.Ge.set(e,new ME),this.We.getRemoteKeysForTarget(e).forEach(t=>{this.Xe(e,t,null)})}It(e,t){return this.We.getRemoteKeysForTarget(e).has(t)}}function ch(){return new Rt(ge.comparator)}function LE(){return new Rt(ge.comparator)}const Gk={asc:"ASCENDING",desc:"DESCENDING"},Kk={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Qk={and:"AND",or:"OR"};class Yk{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function um(n,e){return n.useProto3Json||bu(e)?e:{value:e}}function Bh(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function OT(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function Xk(n,e){return Bh(n,e.toTimestamp())}function Mn(n){return He(!!n,49232),Te.fromTimestamp(function(t){const r=rs(t);return new lt(r.seconds,r.nanos)}(n))}function ug(n,e){return cm(n,e).canonicalString()}function cm(n,e){const t=function(s){return new Ze(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function MT(n){const e=Ze.fromString(n);return He(zT(e),10190,{key:e.toString()}),e}function Wh(n,e){return ug(n.databaseId,e.path)}function iu(n,e){const t=MT(e);if(t.get(1)!==n.databaseId.projectId)throw new ne($.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new ne($.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new ge(VT(t))}function LT(n,e){return ug(n.databaseId,e)}function Jk(n){const e=MT(n);return e.length===4?Ze.emptyPath():VT(e)}function hm(n){return new Ze(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function VT(n){return He(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function VE(n,e,t){return{name:Wh(n,e),fields:t.value.mapValue.fields}}function Zk(n,e){return"found"in e?function(r,s){He(!!s.found,43571),s.found.name,s.found.updateTime;const a=iu(r,s.found.name),u=Mn(s.found.updateTime),d=s.found.createTime?Mn(s.found.createTime):Te.min(),f=new dn({mapValue:{fields:s.found.fields}});return Bt.newFoundDocument(a,u,d,f)}(n,e):"missing"in e?function(r,s){He(!!s.missing,3894),He(!!s.readTime,22933);const a=iu(r,s.missing),u=Mn(s.readTime);return Bt.newNoDocument(a,u)}(n,e):_e(7234,{result:e})}function ex(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(m){return m==="NO_CHANGE"?0:m==="ADD"?1:m==="REMOVE"?2:m==="CURRENT"?3:m==="RESET"?4:_e(39313,{state:m})}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],a=function(m,v){return m.useProto3Json?(He(v===void 0||typeof v=="string",58123),Yt.fromBase64String(v||"")):(He(v===void 0||v instanceof Buffer||v instanceof Uint8Array,16193),Yt.fromUint8Array(v||new Uint8Array))}(n,e.targetChange.resumeToken),u=e.targetChange.cause,d=u&&function(m){const v=m.code===void 0?$.UNKNOWN:NT(m.code);return new ne(v,m.message||"")}(u);t=new DT(r,s,a,d||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=iu(n,r.document.name),a=Mn(r.document.updateTime),u=r.document.createTime?Mn(r.document.createTime):Te.min(),d=new dn({mapValue:{fields:r.document.fields}}),f=Bt.newFoundDocument(s,a,u,d),m=r.targetIds||[],v=r.removedTargetIds||[];t=new Th(m,v,f.key,f)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=iu(n,r.document),a=r.readTime?Mn(r.readTime):Te.min(),u=Bt.newNoDocument(s,a),d=r.removedTargetIds||[];t=new Th([],d,u.key,u)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=iu(n,r.document),a=r.removedTargetIds||[];t=new Th([],a,s,null)}else{if(!("filter"in e))return _e(11601,{At:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:a}=r,u=new qk(s,a),d=r.targetId;t=new bT(d,u)}}return t}function FT(n,e){let t;if(e instanceof Ou)t={update:VE(n,e.key,e.value)};else if(e instanceof Rd)t={delete:Wh(n,e.key)};else if(e instanceof ms)t={update:VE(n,e.key,e.data),updateMask:ux(e.fieldMask)};else{if(!(e instanceof kT))return _e(16599,{Rt:e.type});t={verify:Wh(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(a,u){const d=u.transform;if(d instanceof zh)return{fieldPath:u.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(d instanceof Ra)return{fieldPath:u.field.canonicalString(),appendMissingElements:{values:d.elements}};if(d instanceof Aa)return{fieldPath:u.field.canonicalString(),removeAllFromArray:{values:d.elements}};if(d instanceof yu)return{fieldPath:u.field.canonicalString(),increment:d.Ee};throw _e(20930,{transform:u.transform})}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,a){return a.updateTime!==void 0?{updateTime:Xk(s,a.updateTime)}:a.exists!==void 0?{exists:a.exists}:_e(27497)}(n,e.precondition)),t}function tx(n,e){return n&&n.length>0?(He(e!==void 0,14353),n.map(t=>function(s,a){let u=s.updateTime?Mn(s.updateTime):Mn(a);return u.isEqual(Te.min())&&(u=Mn(a)),new Uk(u,s.transformResults||[])}(t,e))):[]}function nx(n,e){return{documents:[LT(n,e.path)]}}function rx(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=LT(n,s);const a=function(m){if(m.length!==0)return jT(pr.create(m,"and"))}(e.filters);a&&(t.structuredQuery.where=a);const u=function(m){if(m.length!==0)return m.map(v=>function(T){return{field:la(T.field),direction:ox(T.dir)}}(v))}(e.orderBy);u&&(t.structuredQuery.orderBy=u);const d=um(n,e.limit);return d!==null&&(t.structuredQuery.limit=d),e.startAt&&(t.structuredQuery.startAt=function(m){return{before:m.inclusive,values:m.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(m){return{before:!m.inclusive,values:m.position}}(e.endAt)),{Vt:t,parent:s}}function ix(n){let e=Jk(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){He(r===1,65062);const v=t.from[0];v.allDescendants?s=v.collectionId:e=e.child(v.collectionId)}let a=[];t.where&&(a=function(E){const T=UT(E);return T instanceof pr&&hT(T)?T.getFilters():[T]}(t.where));let u=[];t.orderBy&&(u=function(E){return E.map(T=>function(V){return new jh(ua(V.field),function(B){switch(B){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(V.direction))}(T))}(t.orderBy));let d=null;t.limit&&(d=function(E){let T;return T=typeof E=="object"?E.value:E,bu(T)?null:T}(t.limit));let f=null;t.startAt&&(f=function(E){const T=!!E.before,D=E.values||[];return new Uh(D,T)}(t.startAt));let m=null;return t.endAt&&(m=function(E){const T=!E.before,D=E.values||[];return new Uh(D,T)}(t.endAt)),Ak(e,s,u,a,d,"F",f,m)}function sx(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return _e(28987,{purpose:s})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function UT(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=ua(t.unaryFilter.field);return Ct.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=ua(t.unaryFilter.field);return Ct.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const a=ua(t.unaryFilter.field);return Ct.create(a,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const u=ua(t.unaryFilter.field);return Ct.create(u,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return _e(61313);default:return _e(60726)}}(n):n.fieldFilter!==void 0?function(t){return Ct.create(ua(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return _e(58110);default:return _e(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return pr.create(t.compositeFilter.filters.map(r=>UT(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return _e(1026)}}(t.compositeFilter.op))}(n):_e(30097,{filter:n})}function ox(n){return Gk[n]}function ax(n){return Kk[n]}function lx(n){return Qk[n]}function la(n){return{fieldPath:n.canonicalString()}}function ua(n){return Qt.fromServerFormat(n.fieldPath)}function jT(n){return n instanceof Ct?function(t){if(t.op==="=="){if(CE(t.value))return{unaryFilter:{field:la(t.field),op:"IS_NAN"}};if(IE(t.value))return{unaryFilter:{field:la(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(CE(t.value))return{unaryFilter:{field:la(t.field),op:"IS_NOT_NAN"}};if(IE(t.value))return{unaryFilter:{field:la(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:la(t.field),op:ax(t.op),value:t.value}}}(n):n instanceof pr?function(t){const r=t.getFilters().map(s=>jT(s));return r.length===1?r[0]:{compositeFilter:{op:lx(t.op),filters:r}}}(n):_e(54877,{filter:n})}function ux(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function zT(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cg{constructor(){this.qr=new bt(jt.Qr),this.$r=new bt(jt.Ur)}isEmpty(){return this.qr.isEmpty()}addReference(e,t){const r=new jt(e,t);this.qr=this.qr.add(r),this.$r=this.$r.add(r)}Kr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Wr(new jt(e,t))}Gr(e,t){e.forEach(r=>this.removeReference(r,t))}zr(e){const t=new ge(new Ze([])),r=new jt(t,e),s=new jt(t,e+1),a=[];return this.$r.forEachInRange([r,s],u=>{this.Wr(u),a.push(u.key)}),a}jr(){this.qr.forEach(e=>this.Wr(e))}Wr(e){this.qr=this.qr.delete(e),this.$r=this.$r.delete(e)}Jr(e){const t=new ge(new Ze([])),r=new jt(t,e),s=new jt(t,e+1);let a=ze();return this.$r.forEachInRange([r,s],u=>{a=a.add(u.key)}),a}containsKey(e){const t=new jt(e,0),r=this.qr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class jt{constructor(e,t){this.key=e,this.Hr=t}static Qr(e,t){return ge.comparator(e.key,t.key)||De(e.Hr,t.Hr)}static Ur(e,t){return De(e.Hr,t.Hr)||ge.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fg="LocalStore",bx=3e8;class Dx{constructor(e,t,r,s){this.persistence=e,this.Cs=t,this.serializer=s,this.Fs=new Rt(De),this.Ms=new ao(a=>rg(a),ig),this.xs=new Map,this.Os=e.getRemoteDocumentCache(),this.hi=e.getTargetCache(),this.Ti=e.getBundleCache(),this.Ns(r)}Ns(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new wx(this.Os,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Os.setIndexManager(this.indexManager),this.Cs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.Fs))}}function Ox(n,e,t,r){return new Dx(n,e,t,r)}async function qT(n,e){const t=Re(n);return await t.persistence.runTransaction("Handle user change","readonly",r=>{let s;return t.mutationQueue.getAllMutationBatches(r).next(a=>(s=a,t.Ns(e),t.mutationQueue.getAllMutationBatches(r))).next(a=>{const u=[],d=[];let f=ze();for(const m of s){u.push(m.batchId);for(const v of m.mutations)f=f.add(v.key)}for(const m of a){d.push(m.batchId);for(const v of m.mutations)f=f.add(v.key)}return t.localDocuments.getDocuments(r,f).next(m=>({Bs:m,removedBatchIds:u,addedBatchIds:d}))})})}function Mx(n,e){const t=Re(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",r=>{const s=e.batch.keys(),a=t.Os.newChangeBuffer({trackRemovals:!0});return function(d,f,m,v){const E=m.batch,T=E.keys();let D=G.resolve();return T.forEach(V=>{D=D.next(()=>v.getEntry(f,V)).next(q=>{const B=m.docVersions.get(V);He(B!==null,48541),q.version.compareTo(B)<0&&(E.applyToRemoteDocument(q,m),q.isValidDocument()&&(q.setReadTime(m.commitVersion),v.addEntry(q)))})}),D.next(()=>d.mutationQueue.removeMutationBatch(f,E))}(t,r,e,a).next(()=>a.apply(r)).next(()=>t.mutationQueue.performConsistencyCheck(r)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(r,s,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,function(d){let f=ze();for(let m=0;m<d.mutationResults.length;++m)d.mutationResults[m].transformResults.length>0&&(f=f.add(d.batch.mutations[m].key));return f}(e))).next(()=>t.localDocuments.getDocuments(r,s))})}function $T(n){const e=Re(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.hi.getLastRemoteSnapshotVersion(t))}function Lx(n,e){const t=Re(n),r=e.snapshotVersion;let s=t.Fs;return t.persistence.runTransaction("Apply remote event","readwrite-primary",a=>{const u=t.Os.newChangeBuffer({trackRemovals:!0});s=t.Fs;const d=[];e.targetChanges.forEach((v,E)=>{const T=s.get(E);if(!T)return;d.push(t.hi.removeMatchingKeys(a,v.removedDocuments,E).next(()=>t.hi.addMatchingKeys(a,v.addedDocuments,E)));let D=T.withSequenceNumber(a.currentSequenceNumber);e.targetMismatches.get(E)!==null?D=D.withResumeToken(Yt.EMPTY_BYTE_STRING,Te.min()).withLastLimboFreeSnapshotVersion(Te.min()):v.resumeToken.approximateByteSize()>0&&(D=D.withResumeToken(v.resumeToken,r)),s=s.insert(E,D),function(q,B,J){return q.resumeToken.approximateByteSize()===0||B.snapshotVersion.toMicroseconds()-q.snapshotVersion.toMicroseconds()>=bx?!0:J.addedDocuments.size+J.modifiedDocuments.size+J.removedDocuments.size>0}(T,D,v)&&d.push(t.hi.updateTargetData(a,D))});let f=di(),m=ze();if(e.documentUpdates.forEach(v=>{e.resolvedLimboDocuments.has(v)&&d.push(t.persistence.referenceDelegate.updateLimboDocument(a,v))}),d.push(Vx(a,u,e.documentUpdates).next(v=>{f=v.Ls,m=v.ks})),!r.isEqual(Te.min())){const v=t.hi.getLastRemoteSnapshotVersion(a).next(E=>t.hi.setTargetsMetadata(a,a.currentSequenceNumber,r));d.push(v)}return G.waitFor(d).next(()=>u.apply(a)).next(()=>t.localDocuments.getLocalViewOfDocuments(a,f,m)).next(()=>f)}).then(a=>(t.Fs=s,a))}function Vx(n,e,t){let r=ze(),s=ze();return t.forEach(a=>r=r.add(a)),e.getEntries(n,r).next(a=>{let u=di();return t.forEach((d,f)=>{const m=a.get(d);f.isFoundDocument()!==m.isFoundDocument()&&(s=s.add(d)),f.isNoDocument()&&f.version.isEqual(Te.min())?(e.removeEntry(d,f.readTime),u=u.insert(d,f)):!m.isValidDocument()||f.version.compareTo(m.version)>0||f.version.compareTo(m.version)===0&&m.hasPendingWrites?(e.addEntry(f),u=u.insert(d,f)):oe(fg,"Ignoring outdated watch update for ",d,". Current version:",m.version," Watch version:",f.version)}),{Ls:u,ks:s}})}function Fx(n,e){const t=Re(n);return t.persistence.runTransaction("Get next mutation batch","readonly",r=>(e===void 0&&(e=eg),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e)))}function Ux(n,e){const t=Re(n);return t.persistence.runTransaction("Allocate target","readwrite",r=>{let s;return t.hi.getTargetData(r,e).next(a=>a?(s=a,G.resolve(s)):t.hi.allocateTargetId(r).next(u=>(s=new Hi(e,u,"TargetPurposeListen",r.currentSequenceNumber),t.hi.addTargetData(r,s).next(()=>s))))}).then(r=>{const s=t.Fs.get(r.targetId);return(s===null||r.snapshotVersion.compareTo(s.snapshotVersion)>0)&&(t.Fs=t.Fs.insert(r.targetId,r),t.Ms.set(e,r.targetId)),r})}async function dm(n,e,t){const r=Re(n),s=r.Fs.get(e),a=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",a,u=>r.persistence.referenceDelegate.removeTarget(u,s))}catch(u){if(!Ua(u))throw u;oe(fg,`Failed to update sequence numbers for target ${e}: ${u}`)}r.Fs=r.Fs.remove(e),r.Ms.delete(s.target)}function zE(n,e,t){const r=Re(n);let s=Te.min(),a=ze();return r.persistence.runTransaction("Execute query","readwrite",u=>function(f,m,v){const E=Re(f),T=E.Ms.get(v);return T!==void 0?G.resolve(E.Fs.get(T)):E.hi.getTargetData(m,v)}(r,u,Nr(e)).next(d=>{if(d)return s=d.lastLimboFreeSnapshotVersion,r.hi.getMatchingKeysForTargetId(u,d.targetId).next(f=>{a=f})}).next(()=>r.Cs.getDocumentsMatchingQuery(u,e,t?s:Te.min(),t?a:ze())).next(d=>(jx(r,kk(e),d),{documents:d,qs:a})))}function jx(n,e,t){let r=n.xs.get(e)||Te.min();t.forEach((s,a)=>{a.readTime.compareTo(r)>0&&(r=a.readTime)}),n.xs.set(e,r)}class BE{constructor(){this.activeTargetIds=Mk()}Gs(e){this.activeTargetIds=this.activeTargetIds.add(e)}zs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class zx{constructor(){this.Fo=new BE,this.Mo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.Fo.Gs(e),this.Mo[e]||"not-current"}updateQueryState(e,t,r){this.Mo[e]=t}removeLocalQueryTarget(e){this.Fo.zs(e)}isLocalQueryTarget(e){return this.Fo.activeTargetIds.has(e)}clearQueryState(e){delete this.Mo[e]}getAllActiveQueryTargets(){return this.Fo.activeTargetIds}isActiveQueryTarget(e){return this.Fo.activeTargetIds.has(e)}start(){return this.Fo=new BE,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tn="WebChannelConnection";class Hx extends qx{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,r,s,a){const u=fm();return new Promise((d,f)=>{const m=new W0;m.setWithCredentials(!0),m.listenOnce(q0.COMPLETE,()=>{try{switch(m.getLastErrorCode()){case yh.NO_ERROR:const E=m.getResponseJson();oe(tn,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(E)),d(E);break;case yh.TIMEOUT:oe(tn,`RPC '${e}' ${u} timed out`),f(new ne($.DEADLINE_EXCEEDED,"Request time out"));break;case yh.HTTP_ERROR:const T=m.getStatus();if(oe(tn,`RPC '${e}' ${u} failed with status:`,T,"response text:",m.getResponseText()),T>0){let D=m.getResponseJson();Array.isArray(D)&&(D=D[0]);const V=D?.error;if(V&&V.status&&V.message){const q=function(J){const re=J.toLowerCase().replace(/_/g,"-");return Object.values($).indexOf(re)>=0?re:$.UNKNOWN}(V.status);f(new ne(q,V.message))}else f(new ne($.UNKNOWN,"Server responded with status "+m.getStatus()))}else f(new ne($.UNAVAILABLE,"Connection failed."));break;default:_e(9055,{c_:e,streamId:u,l_:m.getLastErrorCode(),h_:m.getLastError()})}}finally{oe(tn,`RPC '${e}' ${u} completed.`)}});const v=JSON.stringify(s);oe(tn,`RPC '${e}' ${u} sending request:`,s),m.send(t,"POST",v,r,15)})}P_(e,t,r){const s=fm(),a=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],u=G0(),d=H0(),f={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},m=this.longPollingOptions.timeoutSeconds;m!==void 0&&(f.longPollingTimeout=Math.round(1e3*m)),this.useFetchStreams&&(f.useFetchStreams=!0),this.zo(f.initMessageHeaders,t,r),f.encodeInitMessageHeaders=!0;const v=a.join("");oe(tn,`Creating RPC '${e}' stream ${s}: ${v}`,f);const E=u.createWebChannel(v,f);this.T_(E);let T=!1,D=!1;const V=new $x({Ho:B=>{D?oe(tn,`Not sending because RPC '${e}' stream ${s} is closed:`,B):(T||(oe(tn,`Opening RPC '${e}' stream ${s} transport.`),E.open(),T=!0),oe(tn,`RPC '${e}' stream ${s} sending:`,B),E.send(B))},Yo:()=>E.close()}),q=(B,J,re)=>{B.listen(J,ae=>{try{re(ae)}catch(pe){setTimeout(()=>{throw pe},0)}})};return q(E,Gl.EventType.OPEN,()=>{D||(oe(tn,`RPC '${e}' stream ${s} transport opened.`),V.s_())}),q(E,Gl.EventType.CLOSE,()=>{D||(D=!0,oe(tn,`RPC '${e}' stream ${s} transport closed`),V.__(),this.I_(E))}),q(E,Gl.EventType.ERROR,B=>{D||(D=!0,ts(tn,`RPC '${e}' stream ${s} transport errored. Name:`,B.name,"Message:",B.message),V.__(new ne($.UNAVAILABLE,"The operation could not be completed")))}),q(E,Gl.EventType.MESSAGE,B=>{var J;if(!D){const re=B.data[0];He(!!re,16349);const ae=re,pe=ae?.error||((J=ae[0])===null||J===void 0?void 0:J.error);if(pe){oe(tn,`RPC '${e}' stream ${s} received error:`,pe);const Me=pe.status;let Ae=function(S){const R=Tt[S];if(R!==void 0)return NT(R)}(Me),O=pe.message;Ae===void 0&&(Ae=$.INTERNAL,O="Unknown error status: "+Me+" with message "+pe.message),D=!0,V.__(new ne(Ae,O)),E.close()}else oe(tn,`RPC '${e}' stream ${s} received:`,re),V.a_(re)}}),q(d,$0.STAT_EVENT,B=>{B.stat===em.PROXY?oe(tn,`RPC '${e}' stream ${s} detected buffering proxy`):B.stat===em.NOPROXY&&oe(tn,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{V.o_()},0),V}terminate(){this.u_.forEach(e=>e.close()),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter(t=>t===e)}}function Dp(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $E="PersistentStream";class HT{constructor(e,t,r,s,a,u,d,f){this.Fi=e,this.w_=r,this.S_=s,this.connection=a,this.authCredentialsProvider=u,this.appCheckCredentialsProvider=d,this.listener=f,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new pg(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,()=>this.L_()))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===$.RESOURCE_EXHAUSTED?(hi(t.toString()),hi("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===$.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,s])=>{this.b_===t&&this.W_(r,s)},r=>{e(()=>{const s=new ne($.UNKNOWN,"Fetching auth token failed: "+r.message);return this.G_(s)})})}W_(e,t){const r=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo(()=>{r(()=>this.listener.Zo())}),this.stream.e_(()=>{r(()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,()=>(this.x_()&&(this.state=3),Promise.resolve())),this.listener.e_()))}),this.stream.n_(s=>{r(()=>this.G_(s))}),this.stream.onMessage(s=>{r(()=>++this.C_==1?this.j_(s):this.onNext(s))})}O_(){this.state=5,this.F_.g_(async()=>{this.state=0,this.start()})}G_(e){return oe($E,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget(()=>this.b_===e?t():(oe($E,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Gx extends HT{constructor(e,t,r,s,a,u){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,s,u),this.serializer=a}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=ex(this.serializer,e),r=function(a){if(!("targetChange"in a))return Te.min();const u=a.targetChange;return u.targetIds&&u.targetIds.length?Te.min():u.readTime?Mn(u.readTime):Te.min()}(e);return this.listener.J_(t,r)}H_(e){const t={};t.database=hm(this.serializer),t.addTarget=function(a,u){let d;const f=u.target;if(d=om(f)?{documents:nx(a,f)}:{query:rx(a,f).Vt},d.targetId=u.targetId,u.resumeToken.approximateByteSize()>0){d.resumeToken=OT(a,u.resumeToken);const m=um(a,u.expectedCount);m!==null&&(d.expectedCount=m)}else if(u.snapshotVersion.compareTo(Te.min())>0){d.readTime=Bh(a,u.snapshotVersion.toTimestamp());const m=um(a,u.expectedCount);m!==null&&(d.expectedCount=m)}return d}(this.serializer,e);const r=sx(this.serializer,e);r&&(t.labels=r),this.k_(t)}Y_(e){const t={};t.database=hm(this.serializer),t.removeTarget=e,this.k_(t)}}class Kx extends HT{constructor(e,t,r,s,a,u){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,s,u),this.serializer=a}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return He(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,He(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){He(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=tx(e.writeResults,e.commitTime),r=Mn(e.commitTime);return this.listener.ta(r,t)}na(){const e={};e.database=hm(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map(r=>FT(this.serializer,r))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qx{}class Yx extends Qx{constructor(e,t,r,s){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=s,this.ra=!1}ia(){if(this.ra)throw new ne($.FAILED_PRECONDITION,"The client has already been terminated.")}Wo(e,t,r,s){return this.ia(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,u])=>this.connection.Wo(e,cm(t,r),s,a,u)).catch(a=>{throw a.name==="FirebaseError"?(a.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new ne($.UNKNOWN,a.toString())})}Jo(e,t,r,s,a){return this.ia(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([u,d])=>this.connection.Jo(e,cm(t,r),s,u,d,a)).catch(u=>{throw u.name==="FirebaseError"?(u.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),u):new ne($.UNKNOWN,u.toString())})}terminate(){this.ra=!0,this.connection.terminate()}}class Xx{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.sa=0,this.oa=null,this._a=!0}aa(){this.sa===0&&(this.ua("Unknown"),this.oa=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.oa=null,this.ca("Backend didn't respond within 10 seconds."),this.ua("Offline"),Promise.resolve())))}la(e){this.state==="Online"?this.ua("Unknown"):(this.sa++,this.sa>=1&&(this.ha(),this.ca(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.ua("Offline")))}set(e){this.ha(),this.sa=0,e==="Online"&&(this._a=!1),this.ua(e)}ua(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}ca(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eo="RemoteStore";class Jx{constructor(e,t,r,s,a){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=a,this.Ea.xo(u=>{r.enqueueAndForget(async()=>{lo(this)&&(oe(eo,"Restarting streams for network reachability change."),await async function(f){const m=Re(f);m.Ia.add(4),await Lu(m),m.Aa.set("Unknown"),m.Ia.delete(4),await kd(m)}(this))})}),this.Aa=new Xx(r,s)}}async function kd(n){if(lo(n))for(const e of n.da)await e(!0)}async function Lu(n){for(const e of n.da)await e(!1)}function GT(n,e){const t=Re(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),yg(t)?_g(t):ja(t).x_()&&gg(t,e))}function mg(n,e){const t=Re(n),r=ja(t);t.Ta.delete(e),r.x_()&&KT(t,e),t.Ta.size===0&&(r.x_()?r.B_():lo(t)&&t.Aa.set("Unknown"))}function gg(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Te.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}ja(n).H_(e)}function KT(n,e){n.Ra.$e(e),ja(n).Y_(e)}function _g(n){n.Ra=new Hk({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),ja(n).start(),n.Aa.aa()}function yg(n){return lo(n)&&!ja(n).M_()&&n.Ta.size>0}function lo(n){return Re(n).Ia.size===0}function QT(n){n.Ra=void 0}async function Zx(n){n.Aa.set("Online")}async function eN(n){n.Ta.forEach((e,t)=>{gg(n,e)})}async function tN(n,e){QT(n),yg(n)?(n.Aa.la(e),_g(n)):n.Aa.set("Unknown")}async function nN(n,e,t){if(n.Aa.set("Online"),e instanceof DT&&e.state===2&&e.cause)try{await async function(s,a){const u=a.cause;for(const d of a.targetIds)s.Ta.has(d)&&(await s.remoteSyncer.rejectListen(d,u),s.Ta.delete(d),s.Ra.removeTarget(d))}(n,e)}catch(r){oe(eo,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await $h(n,r)}else if(e instanceof Th?n.Ra.Ye(e):e instanceof bT?n.Ra.it(e):n.Ra.et(e),!t.isEqual(Te.min()))try{const r=await $T(n.localStore);t.compareTo(r)>=0&&await function(a,u){const d=a.Ra.Pt(u);return d.targetChanges.forEach((f,m)=>{if(f.resumeToken.approximateByteSize()>0){const v=a.Ta.get(m);v&&a.Ta.set(m,v.withResumeToken(f.resumeToken,u))}}),d.targetMismatches.forEach((f,m)=>{const v=a.Ta.get(f);if(!v)return;a.Ta.set(f,v.withResumeToken(Yt.EMPTY_BYTE_STRING,v.snapshotVersion)),KT(a,f);const E=new Hi(v.target,f,m,v.sequenceNumber);gg(a,E)}),a.remoteSyncer.applyRemoteEvent(d)}(n,t)}catch(r){oe(eo,"Failed to raise snapshot:",r),await $h(n,r)}}async function $h(n,e,t){if(!Ua(e))throw e;n.Ia.add(1),await Lu(n),n.Aa.set("Offline"),t||(t=()=>$T(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{oe(eo,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await kd(n)})}function YT(n,e){return e().catch(t=>$h(n,t,e))}async function xd(n){const e=Re(n),t=os(e);let r=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:eg;for(;rN(e);)try{const s=await Fx(e.localStore,r);if(s===null){e.Pa.length===0&&t.B_();break}r=s.batchId,iN(e,s)}catch(s){await $h(e,s)}XT(e)&&JT(e)}function rN(n){return lo(n)&&n.Pa.length<10}function iN(n,e){n.Pa.push(e);const t=os(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function XT(n){return lo(n)&&!os(n).M_()&&n.Pa.length>0}function JT(n){os(n).start()}async function sN(n){os(n).na()}async function oN(n){const e=os(n);for(const t of n.Pa)e.X_(t.mutations)}async function aN(n,e,t){const r=n.Pa.shift(),s=ag.from(r,e,t);await YT(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await xd(n)}async function lN(n,e){e&&os(n).Z_&&await async function(r,s){if(function(u){return xT(u)&&u!==$.ABORTED}(s.code)){const a=r.Pa.shift();os(r).N_(),await YT(r,()=>r.remoteSyncer.rejectFailedWrite(a.batchId,s)),await xd(r)}}(n,e),XT(n)&&JT(n)}async function HE(n,e){const t=Re(n);t.asyncQueue.verifyOperationInProgress(),oe(eo,"RemoteStore received new credentials");const r=lo(t);t.Ia.add(3),await Lu(t),r&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await kd(t)}async function uN(n,e){const t=Re(n);e?(t.Ia.delete(2),await kd(t)):e||(t.Ia.add(2),await Lu(t),t.Aa.set("Unknown"))}function ja(n){return n.Va||(n.Va=function(t,r,s){const a=Re(t);return a.ia(),new Gx(r,a.connection,a.authCredentials,a.appCheckCredentials,a.serializer,s)}(n.datastore,n.asyncQueue,{Zo:Zx.bind(null,n),e_:eN.bind(null,n),n_:tN.bind(null,n),J_:nN.bind(null,n)}),n.da.push(async e=>{e?(n.Va.N_(),yg(n)?_g(n):n.Aa.set("Unknown")):(await n.Va.stop(),QT(n))})),n.Va}function os(n){return n.ma||(n.ma=function(t,r,s){const a=Re(t);return a.ia(),new Kx(r,a.connection,a.authCredentials,a.appCheckCredentials,a.serializer,s)}(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:sN.bind(null,n),n_:lN.bind(null,n),ea:oN.bind(null,n),ta:aN.bind(null,n)}),n.da.push(async e=>{e?(n.ma.N_(),await xd(n)):(await n.ma.stop(),n.Pa.length>0&&(oe(eo,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))})),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cN{constructor(){this.ya=void 0,this.wa=[]}Sa(){return this.wa.some(e=>e.ba())}}class hN{constructor(){this.queries=KE(),this.onlineState="Unknown",this.Da=new Set}terminate(){(function(t,r){const s=Re(t),a=s.queries;s.queries=KE(),a.forEach((u,d)=>{for(const f of d.wa)f.onError(r)})})(this,new ne($.ABORTED,"Firestore shutting down"))}}function KE(){return new ao(n=>gT(n),Td)}async function ZT(n,e){const t=Re(n);let r=3;const s=e.query;let a=t.queries.get(s);a?!a.Sa()&&e.ba()&&(r=2):(a=new cN,r=e.ba()?0:1);try{switch(r){case 0:a.ya=await t.onListen(s,!0);break;case 1:a.ya=await t.onListen(s,!1);break;case 2:await t.onFirstRemoteStoreListen(s)}}catch(u){const d=Eg(u,`Initialization of query '${aa(e.query)}' failed`);return void e.onError(d)}t.queries.set(s,a),a.wa.push(e),e.va(t.onlineState),a.ya&&e.Ca(a.ya)&&wg(t)}async function eI(n,e){const t=Re(n),r=e.query;let s=3;const a=t.queries.get(r);if(a){const u=a.wa.indexOf(e);u>=0&&(a.wa.splice(u,1),a.wa.length===0?s=e.ba()?0:1:!a.Sa()&&e.ba()&&(s=2))}switch(s){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function dN(n,e){const t=Re(n);let r=!1;for(const s of e){const a=s.query,u=t.queries.get(a);if(u){for(const d of u.wa)d.Ca(s)&&(r=!0);u.ya=s}}r&&wg(t)}function fN(n,e,t){const r=Re(n),s=r.queries.get(e);if(s)for(const a of s.wa)a.onError(t);r.queries.delete(e)}function wg(n){n.Da.forEach(e=>{e.next()})}var pm,QE;(QE=pm||(pm={})).Fa="default",QE.Cache="cache";class tI{constructor(e,t,r){this.query=e,this.Ma=t,this.xa=!1,this.Oa=null,this.onlineState="Unknown",this.options=r||{}}Ca(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new ka(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.xa?this.Na(e)&&(this.Ma.next(e),t=!0):this.Ba(e,this.onlineState)&&(this.La(e),t=!0),this.Oa=e,t}onError(e){this.Ma.error(e)}va(e){this.onlineState=e;let t=!1;return this.Oa&&!this.xa&&this.Ba(this.Oa,e)&&(this.La(this.Oa),t=!0),t}Ba(e,t){if(!e.fromCache||!this.ba())return!0;const r=t!=="Offline";return(!this.options.ka||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}Na(e){if(e.docChanges.length>0)return!0;const t=this.Oa&&this.Oa.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}La(e){e=ka.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.xa=!0,this.Ma.next(e)}ba(){return this.options.source!==pm.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bN{constructor(e){this.datastore=e,this.readVersions=new Map,this.mutations=[],this.committed=!1,this.lastTransactionError=null,this.writtenDocs=new Set}async lookup(e){if(this.ensureCommitNotCalled(),this.mutations.length>0)throw this.lastTransactionError=new ne($.INVALID_ARGUMENT,"Firestore transactions require all reads to be executed before all writes."),this.lastTransactionError;const t=await async function(s,a){const u=Re(s),d={documents:a.map(E=>Wh(u.serializer,E))},f=await u.Jo("BatchGetDocuments",u.serializer.databaseId,Ze.emptyPath(),d,a.length),m=new Map;f.forEach(E=>{const T=Zk(u.serializer,E);m.set(T.key.toString(),T)});const v=[];return a.forEach(E=>{const T=m.get(E.toString());He(!!T,55234,{key:E}),v.push(T)}),v}(this.datastore,e);return t.forEach(r=>this.recordVersion(r)),t}set(e,t){this.write(t.toMutation(e,this.precondition(e))),this.writtenDocs.add(e.toString())}update(e,t){try{this.write(t.toMutation(e,this.preconditionForUpdate(e)))}catch(r){this.lastTransactionError=r}this.writtenDocs.add(e.toString())}delete(e){this.write(new Rd(e,this.precondition(e))),this.writtenDocs.add(e.toString())}async commit(){if(this.ensureCommitNotCalled(),this.lastTransactionError)throw this.lastTransactionError;const e=this.readVersions;this.mutations.forEach(t=>{e.delete(t.key.toString())}),e.forEach((t,r)=>{const s=ge.fromPath(r);this.mutations.push(new kT(s,this.precondition(s)))}),await async function(r,s){const a=Re(r),u={writes:s.map(d=>FT(a.serializer,d))};await a.Wo("Commit",a.serializer.databaseId,Ze.emptyPath(),u)}(this.datastore,this.mutations),this.committed=!0}recordVersion(e){let t;if(e.isFoundDocument())t=e.version;else{if(!e.isNoDocument())throw _e(50498,{Wu:e.constructor.name});t=Te.min()}const r=this.readVersions.get(e.key.toString());if(r){if(!t.isEqual(r))throw new ne($.ABORTED,"Document version changed between two reads.")}else this.readVersions.set(e.key.toString(),t)}precondition(e){const t=this.readVersions.get(e.toString());return!this.writtenDocs.has(e.toString())&&t?t.isEqual(Te.min())?sn.exists(!1):sn.updateTime(t):sn.none()}preconditionForUpdate(e){const t=this.readVersions.get(e.toString());if(!this.writtenDocs.has(e.toString())&&t){if(t.isEqual(Te.min()))throw new ne($.INVALID_ARGUMENT,"Can't update a document that doesn't exist.");return sn.updateTime(t)}return sn.exists(!0)}write(e){this.ensureCommitNotCalled(),this.mutations.push(e)}ensureCommitNotCalled(){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Dn(Yt.fromBase64String(e))}catch(t){throw new ne($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Dn(Yt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Dn._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Nu(e,Dn._jsonSchema))return Dn.fromBase64String(e.bytes)}}Dn._jsonSchemaVersion="firestore/bytes/1.0",Dn._jsonSchema={type:St("string",Dn._jsonSchemaVersion),bytes:St("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fu{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new ne($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Qt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class br{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new ne($.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new ne($.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return De(this._lat,e._lat)||De(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:br._jsonSchemaVersion}}static fromJSON(e){if(Nu(e,br._jsonSchema))return new br(e.latitude,e.longitude)}}br._jsonSchemaVersion="firestore/geoPoint/1.0",br._jsonSchema={type:St("string",br._jsonSchemaVersion),latitude:St("number"),longitude:St("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dr{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,s){if(r.length!==s.length)return!1;for(let a=0;a<r.length;++a)if(r[a]!==s[a])return!1;return!0}(this._values,e._values)}toJSON(){return{type:Dr._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Nu(e,Dr._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new Dr(e.vectorValues);throw new ne($.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Dr._jsonSchemaVersion="firestore/vectorValue/1.0",Dr._jsonSchema={type:St("string",Dr._jsonSchemaVersion),vectorValues:St("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nb={maxAttempts:5};function Yl(n,e){if((n=nt(n)).firestore!==e)throw new ne($.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu{static get ALL_TRANSPORTS(){return[da,ur]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=ur&&ur.isAvailable();let r=t&&!ur.previouslyFailed();if(e.webSocketOnly&&(t||Cn("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),r=!0),r)this.transports_=[ur];else{const s=this.transports_=[];for(const a of vu.ALL_TRANSPORTS)a&&a.isAvailable()&&s.push(a);vu.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}vu.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gD=!0;function It(n,e=null){if(n===null)return Ce.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),ee(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new Ft(t,It(e))}if(!(n instanceof Array)&&gD){const t=[];let r=!1;if(an(n,(u,d)=>{if(u.substring(0,1)!=="."){const f=It(d);f.isEmpty()||(r=r||!f.getPriority().isEmpty(),t.push(new Fe(u,f)))}}),t.length===0)return Ce.EMPTY_NODE;const a=Jh(t,lD,u=>u.name,Bg);if(r){const u=Jh(t,pt.getCompare());return new Ce(a,It(e),new si({".priority":u},{".priority":pt}))}else return new Ce(a,It(e),si.Default)}else{let t=Ce.EMPTY_NODE;return an(n,(r,s)=>{if(Lr(n,r)&&r.substring(0,1)!=="."){const a=It(s);(a.isLeafNode()||!a.isEmpty())&&(t=t.updateImmediateChild(r,a))}}),t.updatePriority(It(e))}}cD(It);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _D extends Fd{constructor(e){super(),this.indexPath_=e,ee(!Ve(e)&&Oe(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const r=this.extractChild(e.node),s=this.extractChild(t.node),a=r.compareTo(s);return a===0?co(e.name,t.name):a}makePost(e,t){const r=It(e),s=Ce.EMPTY_NODE.updateChild(this.indexPath_,r);return new Fe(t,s)}maxPost(){const e=Ce.EMPTY_NODE.updateChild(this.indexPath_,zu);return new Fe(to,e)}toString(){return Eu(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{constructor(e){this.indexedFilter_=new Wg(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Iu.getStartPost_(e),this.endPost_=Iu.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const t=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,r=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return t&&r}updateChild(e,t,r,s,a,u){return this.matches(new Fe(t,r))||(r=Ce.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,r,s,a,u)}updateFullNode(e,t,r){t.isLeafNode()&&(t=Ce.EMPTY_NODE);let s=t.withIndex(this.index_);s=s.updatePriority(Ce.EMPTY_NODE);const a=this;return t.forEachChild(pt,(u,d)=>{a.matches(new Fe(u,d))||(s=s.updateImmediateChild(u,Ce.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,s,r)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wD{constructor(e){this.withinDirectionalStart=t=>this.reverse_?this.withinEndPost(t):this.withinStartPost(t),this.withinDirectionalEnd=t=>this.reverse_?this.withinStartPost(t):this.withinEndPost(t),this.withinStartPost=t=>{const r=this.index_.compare(this.rangedFilter_.getStartPost(),t);return this.startIsInclusive_?r<=0:r<0},this.withinEndPost=t=>{const r=this.index_.compare(t,this.rangedFilter_.getEndPost());return this.endIsInclusive_?r<=0:r<0},this.rangedFilter_=new Iu(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,t,r,s,a,u){return this.rangedFilter_.matches(new Fe(t,r))||(r=Ce.EMPTY_NODE),e.getImmediateChild(t).equals(r)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,r,s,a,u):this.fullLimitUpdateChild_(e,t,r,a,u)}updateFullNode(e,t,r){let s;if(t.isLeafNode()||t.isEmpty())s=Ce.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<t.numChildren()&&t.isIndexed(this.index_)){s=Ce.EMPTY_NODE.withIndex(this.index_);let a;this.reverse_?a=t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):a=t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let u=0;for(;a.hasNext()&&u<this.limit_;){const d=a.getNext();if(this.withinDirectionalStart(d))if(this.withinDirectionalEnd(d))s=s.updateImmediateChild(d.name,d.node),u++;else break;else continue}}else{s=t.withIndex(this.index_),s=s.updatePriority(Ce.EMPTY_NODE);let a;this.reverse_?a=s.getReverseIterator(this.index_):a=s.getIterator(this.index_);let u=0;for(;a.hasNext();){const d=a.getNext();u<this.limit_&&this.withinDirectionalStart(d)&&this.withinDirectionalEnd(d)?u++:s=s.updateImmediateChild(d.name,Ce.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,s,r)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,r,s,a){let u;if(this.reverse_){const E=this.index_.getCompare();u=(T,D)=>E(D,T)}else u=this.index_.getCompare();const d=e;ee(d.numChildren()===this.limit_,"");const f=new Fe(t,r),m=this.reverse_?d.getFirstChild(this.index_):d.getLastChild(this.index_),v=this.rangedFilter_.matches(f);if(d.hasChild(t)){const E=d.getImmediateChild(t);let T=s.getChildAfterChild(this.index_,m,this.reverse_);for(;T!=null&&(T.name===t||d.hasChild(T.name));)T=s.getChildAfterChild(this.index_,T,this.reverse_);const D=T==null?1:u(T,f);if(v&&!r.isEmpty()&&D>=0)return a?.trackChildChange(Tu(t,r,E)),d.updateImmediateChild(t,r);{a?.trackChildChange(wu(t,E));const q=d.updateImmediateChild(t,Ce.EMPTY_NODE);return T!=null&&this.rangedFilter_.matches(T)?(a?.trackChildChange(Na(T.name,T.node)),q.updateImmediateChild(T.name,T.node)):q}}else return r.isEmpty()?e:v&&u(m,f)>=0?(a!=null&&(a.trackChildChange(wu(m.name,m.node)),a.trackChildChange(Na(t,r))),d.updateImmediateChild(t,r).updateImmediateChild(m.name,Ce.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ID{constructor(){this.rootNode_=Ce.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var hr;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(hr||(hr={}));function rC(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function $g(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Hg(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class td{constructor(e,t,r){this.path=e,this.affectedTree=t,this.revert=r,this.type=hr.ACK_USER_WRITE,this.source=rC()}operationForChild(e){if(Ve(this.path)){if(this.affectedTree.value!=null)return ee(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Je(e));return new td(Qe(),t,this.revert)}}else return ee(Oe(this.path)===e,"operationForChild called for unrelated child."),new td(tt(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cu{constructor(e,t){this.source=e,this.path=t,this.type=hr.LISTEN_COMPLETE}operationForChild(e){return Ve(this.path)?new Cu(this.source,Qe()):new Cu(this.source,tt(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class no{constructor(e,t,r){this.source=e,this.path=t,this.snap=r,this.type=hr.OVERWRITE}operationForChild(e){return Ve(this.path)?new no(this.source,Qe(),this.snap.getImmediateChild(e)):new no(this.source,tt(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{constructor(e,t,r){this.source=e,this.path=t,this.children=r,this.type=hr.MERGE}operationForChild(e){if(Ve(this.path)){const t=this.children.subtree(new Je(e));return t.isEmpty()?null:t.value?new no(this.source,Qe(),t.value):new Su(this.source,Qe(),t)}else return ee(Oe(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Su(this.source,tt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(e){this.writeTree_=e}static empty(){return new dr(new at(null))}}function lu(n,e,t){if(Ve(e))return new dr(new at(t));{const r=n.writeTree_.findRootMostValueAndPath(e);if(r!=null){const s=r.path;let a=r.value;const u=Tn(s,e);return a=a.updateChild(u,t),new dr(n.writeTree_.set(s,a))}else{const s=new at(t),a=n.writeTree_.setTree(e,s);return new dr(a)}}}function Pw(n,e,t){let r=n;return an(t,(s,a)=>{r=lu(r,vt(e,s),a)}),r}function kw(n,e){if(Ve(e))return dr.empty();{const t=n.writeTree_.setTree(e,new at(null));return new dr(t)}}function Am(n,e){return ho(n,e)!=null}function ho(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Tn(t.path,e)):null}function xw(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(pt,(r,s)=>{e.push(new Fe(r,s))}):n.writeTree_.children.inorderTraversal((r,s)=>{s.value!=null&&e.push(new Fe(r,s.value))}),e}function Zi(n,e){if(Ve(e))return n;{const t=ho(n,e);return t!=null?new dr(new at(t)):new dr(n.writeTree_.subtree(e))}}function Pm(n){return n.writeTree_.isEmpty()}function ba(n,e){return sC(Qe(),n.writeTree_,e)}function sC(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let r=null;return e.children.inorderTraversal((s,a)=>{s===".priority"?(ee(a.value!==null,"Priority writes must always be leaf nodes"),r=a.value):t=sC(vt(n,s),a,t)}),!t.getChild(n).isEmpty()&&r!==null&&(t=t.updateChild(vt(n,".priority"),r)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gg(n,e){return uC(e,n)}function OD(n,e,t,r,s){ee(r>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:r,visible:s}),s&&(n.visibleWrites=lu(n.visibleWrites,e,t)),n.lastWriteId=r}function MD(n,e){for(let t=0;t<n.allWrites.length;t++){const r=n.allWrites[t];if(r.writeId===e)return r}return null}function LD(n,e){const t=n.allWrites.findIndex(d=>d.writeId===e);ee(t>=0,"removeWrite called with nonexistent writeId.");const r=n.allWrites[t];n.allWrites.splice(t,1);let s=r.visible,a=!1,u=n.allWrites.length-1;for(;s&&u>=0;){const d=n.allWrites[u];d.visible&&(u>=t&&VD(d,r.path)?s=!1:Hn(r.path,d.path)&&(a=!0)),u--}if(s){if(a)return FD(n),!0;if(r.snap)n.visibleWrites=kw(n.visibleWrites,r.path);else{const d=r.children;an(d,f=>{n.visibleWrites=kw(n.visibleWrites,vt(r.path,f))})}return!0}else return!1}function VD(n,e){if(n.snap)return Hn(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Hn(vt(n.path,t),e))return!0;return!1}function FD(n){n.visibleWrites=oC(n.allWrites,UD,Qe()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function UD(n){return n.visible}function oC(n,e,t){let r=dr.empty();for(let s=0;s<n.length;++s){const a=n[s];if(e(a)){const u=a.path;let d;if(a.snap)Hn(t,u)?(d=Tn(t,u),r=lu(r,d,a.snap)):Hn(u,t)&&(d=Tn(u,t),r=lu(r,Qe(),a.snap.getChild(d)));else if(a.children){if(Hn(t,u))d=Tn(t,u),r=Pw(r,d,a.children);else if(Hn(u,t))if(d=Tn(u,t),Ve(d))r=Pw(r,Qe(),a.children);else{const f=wa(a.children,Oe(d));if(f){const m=f.getChild(tt(d));r=lu(r,Qe(),m)}}}else throw Oa("WriteRecord should have .snap or .children")}}return r}function aC(n,e,t,r,s){if(!r&&!s){const a=ho(n.visibleWrites,e);if(a!=null)return a;{const u=Zi(n.visibleWrites,e);if(Pm(u))return t;if(t==null&&!Am(u,Qe()))return null;{const d=t||Ce.EMPTY_NODE;return ba(u,d)}}}else{const a=Zi(n.visibleWrites,e);if(!s&&Pm(a))return t;if(!s&&t==null&&!Am(a,Qe()))return null;{const u=function(m){return(m.visible||s)&&(!r||!~r.indexOf(m.writeId))&&(Hn(m.path,e)||Hn(e,m.path))},d=oC(n.allWrites,u,e),f=t||Ce.EMPTY_NODE;return ba(d,f)}}}function jD(n,e,t){let r=Ce.EMPTY_NODE;const s=ho(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(pt,(a,u)=>{r=r.updateImmediateChild(a,u)}),r;if(t){const a=Zi(n.visibleWrites,e);return t.forEachChild(pt,(u,d)=>{const f=ba(Zi(a,new Je(u)),d);r=r.updateImmediateChild(u,f)}),xw(a).forEach(u=>{r=r.updateImmediateChild(u.name,u.node)}),r}else{const a=Zi(n.visibleWrites,e);return xw(a).forEach(u=>{r=r.updateImmediateChild(u.name,u.node)}),r}}function zD(n,e,t,r,s){ee(r||s,"Either existingEventSnap or existingServerSnap must exist");const a=vt(e,t);if(Am(n.visibleWrites,a))return null;{const u=Zi(n.visibleWrites,a);return Pm(u)?s.getChild(t):ba(u,s.getChild(t))}}function BD(n,e,t,r){const s=vt(e,t),a=ho(n.visibleWrites,s);if(a!=null)return a;if(r.isCompleteForChild(t)){const u=Zi(n.visibleWrites,s);return ba(u,r.getNode().getImmediateChild(t))}else return null}function WD(n,e){return ho(n.visibleWrites,e)}function qD(n,e,t,r,s,a,u){let d;const f=Zi(n.visibleWrites,e),m=ho(f,Qe());if(m!=null)d=m;else if(t!=null)d=ba(f,t);else return[];if(d=d.withIndex(u),!d.isEmpty()&&!d.isLeafNode()){const v=[],E=u.getCompare(),T=a?d.getReverseIteratorFrom(r,u):d.getIteratorFrom(r,u);let D=T.getNext();for(;D&&v.length<s;)E(D,r)!==0&&v.push(D),D=T.getNext();return v}else return[]}function $D(){return{visibleWrites:dr.empty(),allWrites:[],lastWriteId:-1}}function nd(n,e,t,r){return aC(n.writeTree,n.treePath,e,t,r)}function Kg(n,e){return jD(n.writeTree,n.treePath,e)}function Nw(n,e,t,r){return zD(n.writeTree,n.treePath,e,t,r)}function rd(n,e){return WD(n.writeTree,vt(n.treePath,e))}function HD(n,e,t,r,s,a){return qD(n.writeTree,n.treePath,e,t,r,s,a)}function Qg(n,e,t){return BD(n.writeTree,n.treePath,e,t)}function lC(n,e){return uC(vt(n.treePath,e),n.writeTree)}function uC(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KD{getCompleteChild(e){return null}getChildAfterChild(e,t,r){return null}}const cC=new KD;class Yg{constructor(e,t,r=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=r}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new ro(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Qg(this.writes_,e,r)}}getChildAfterChild(e,t,r){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:io(this.viewCache_),a=HD(this.writes_,s,t,1,r,e);return a.length===0?null:a[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let od;function mO(n){ee(!od,"__referenceConstructor has already been defined"),od=n}function gO(){return ee(od,"Reference.ts has not been loaded"),od}let _O=1;class Vw{constructor(e){this.listenProvider_=e,this.syncPointTree_=new at(null),this.pendingWriteTree_=$D(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function gC(n,e,t,r,s){return OD(n.pendingWriteTree_,e,t,r,s),s?Bu(n,new no(rC(),e,t)):[]}function Qs(n,e,t=!1){const r=MD(n.pendingWriteTree_,e);if(LD(n.pendingWriteTree_,e)){let a=new at(null);return r.snap!=null?a=a.set(Qe(),!0):an(r.children,u=>{a=a.set(new Je(u),!0)}),Bu(n,new td(r.path,a,t))}else return[]}function zd(n,e,t){return Bu(n,new no($g(),e,t))}function yO(n,e,t){const r=at.fromObject(t);return Bu(n,new Su($g(),e,r))}function vO(n,e){return Bu(n,new Cu($g(),e))}function EO(n,e,t){const r=Zg(n,t);if(r){const s=e_(r),a=s.path,u=s.queryId,d=Tn(a,e),f=new Cu(Hg(u),d);return t_(n,a,f)}else return[]}function Nm(n,e,t,r,s=!1){const a=e._path,u=n.syncPointTree_.get(a);let d=[];if(u&&(e._queryIdentifier==="default"||mC(u,e))){const f=pO(u,e,t,r);hO(u)&&(n.syncPointTree_=n.syncPointTree_.remove(a));const m=f.removed;if(d=f.events,!s){const v=m.findIndex(T=>T._queryParams.loadsAllData())!==-1,E=n.syncPointTree_.findOnPath(a,(T,D)=>cs(D));if(v&&!E){const T=n.syncPointTree_.subtree(a);if(!T.isEmpty()){const D=IO(T);for(let V=0;V<D.length;++V){const q=D[V],B=q.query,J=vC(n,q);n.listenProvider_.startListening(uu(B),ad(n,B),J.hashFn,J.onComplete)}}}!E&&m.length>0&&!r&&(v?n.listenProvider_.stopListening(uu(e),null):m.forEach(T=>{const D=n.queryToTagMap.get(Bd(T));n.listenProvider_.stopListening(uu(T),D)}))}CO(n,m)}return d}function wO(n,e,t,r){const s=Zg(n,r);if(s!=null){const a=e_(s),u=a.path,d=a.queryId,f=Tn(u,e),m=new no(Hg(d),f,t);return t_(n,u,m)}else return[]}function TO(n,e,t,r){const s=Zg(n,r);if(s){const a=e_(s),u=a.path,d=a.queryId,f=Tn(u,e),m=at.fromObject(t),v=new Su(Hg(d),f,m);return t_(n,u,v)}else return[]}function Fw(n,e,t,r=!1){const s=e._path;let a=null,u=!1;n.syncPointTree_.foreachOnPath(s,(T,D)=>{const V=Tn(T,s);a=a||Ea(D,V),u=u||cs(D)});let d=n.syncPointTree_.get(s);d?(u=u||cs(d),a=a||Ea(d,Qe())):(d=new lO,n.syncPointTree_=n.syncPointTree_.set(s,d));let f;a!=null?f=!0:(f=!1,a=Ce.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((D,V)=>{const q=Ea(V,Qe());q&&(a=a.updateImmediateChild(D,q))}));const m=mC(d,e);if(!m&&!e._queryParams.loadsAllData()){const T=Bd(e);ee(!n.queryToTagMap.has(T),"View does not exist, but we have a tag");const D=SO();n.queryToTagMap.set(T,D),n.tagToQueryMap.set(D,T)}const v=Gg(n.pendingWriteTree_,s);let E=fO(d,e,t,v,a,f);if(!m&&!u&&!r){const T=pC(d,e);E=E.concat(RO(n,e,T))}return E}function Jg(n,e,t){const s=n.pendingWriteTree_,a=n.syncPointTree_.findOnPath(e,(u,d)=>{const f=Tn(u,e),m=Ea(d,f);if(m)return m});return aC(s,e,a,t,!0)}function Bu(n,e){return _C(e,n.syncPointTree_,null,Gg(n.pendingWriteTree_,Qe()))}function _C(n,e,t,r){if(Ve(n.path))return yC(n,e,t,r);{const s=e.get(Qe());t==null&&s!=null&&(t=Ea(s,Qe()));let a=[];const u=Oe(n.path),d=n.operationForChild(u),f=e.children.get(u);if(f&&d){const m=t?t.getImmediateChild(u):null,v=lC(r,u);a=a.concat(_C(d,f,m,v))}return s&&(a=a.concat(Xg(s,n,r,t))),a}}function yC(n,e,t,r){const s=e.get(Qe());t==null&&s!=null&&(t=Ea(s,Qe()));let a=[];return e.children.inorderTraversal((u,d)=>{const f=t?t.getImmediateChild(u):null,m=lC(r,u),v=n.operationForChild(u);v&&(a=a.concat(yC(v,d,f,m)))}),s&&(a=a.concat(Xg(s,n,r,t))),a}function vC(n,e){const t=e.query,r=ad(n,t);return{hashFn:()=>(iO(e)||Ce.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return r?EO(n,t._path,r):vO(n,t._path);{const a=Eb(s,t);return Nm(n,t,null,a)}}}}function ad(n,e){const t=Bd(e);return n.queryToTagMap.get(t)}function Bd(n){return n._path.toString()+"$"+n._queryIdentifier}function Zg(n,e){return n.tagToQueryMap.get(e)}function e_(n){const e=n.indexOf("$");return ee(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Je(n.substr(0,e))}}function t_(n,e,t){const r=n.syncPointTree_.get(e);ee(r,"Missing sync point for query tag that we're tracking");const s=Gg(n.pendingWriteTree_,e);return Xg(r,t,s,null)}function IO(n){return n.fold((e,t,r)=>{if(t&&cs(t))return[jd(t)];{let s=[];return t&&(s=fC(t)),an(r,(a,u)=>{s=s.concat(u)}),s}})}function uu(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(gO())(n._repo,n._path):n}function CO(n,e){for(let t=0;t<e.length;++t){const r=e[t];if(!r._queryParams.loadsAllData()){const s=Bd(r),a=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(a)}}}function SO(){return _O++}function RO(n,e,t){const r=e._path,s=ad(n,e),a=vC(n,t),u=n.listenProvider_.startListening(uu(e),s,a.hashFn,a.onComplete),d=n.syncPointTree_.subtree(r);if(s)ee(!cs(d.value),"If we're adding a query, it shouldn't be shadowed");else{const f=d.fold((m,v,E)=>{if(!Ve(m)&&v&&cs(v))return[jd(v).query];{let T=[];return v&&(T=T.concat(fC(v).map(D=>D.query))),an(E,(D,V)=>{T=T.concat(V)}),T}});for(let m=0;m<f.length;++m){const v=f[m];n.listenProvider_.stopListening(uu(v),ad(n,v))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BO{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function l_(n,e){let t=null;for(let r=0;r<e.length;r++){const s=e[r],a=s.getPath();t!==null&&!jg(a,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:a}),t.events.push(s)}t&&n.eventLists_.push(t)}function AC(n,e,t){l_(n,t),PC(n,r=>jg(r,e))}function pi(n,e,t){l_(n,t),PC(n,r=>Hn(r,e)||Hn(e,r))}function PC(n,e){n.recursionDepth_++;let t=!0;for(let r=0;r<n.eventLists_.length;r++){const s=n.eventLists_[r];if(s){const a=s.path;e(a)?(WO(n.eventLists_[r]),n.eventLists_[r]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function WO(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const r=t.getEventRunner();su&&Kt("event: "+t.toString()),Wa(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
